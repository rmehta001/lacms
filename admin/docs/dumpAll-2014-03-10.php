...
mysqli_query($dbh, "LOCK TABLE `GROUP` READ");
mysqli_query($dbh, "BACKUP TABLE `GROUP` TO '/usr/home/eboyer/lacmsBACKUP/$nowYYYYMMDD/'");
mysqli_query($dbh, "UNLOCK TABLES");

mysqli_query($dbh, "LOCK TABLE `USERS` READ");
mysqli_query($dbh, "BACKUP TABLE `USERS` TO '/usr/home/eboyer/lacmsBACKUP/$nowYYYYMMDD/'");
mysqli_query($dbh, "UNLOCK TABLES");

mysqli_query($dbh, "LOCK TABLE PICTURE READ");
...
// original file name path	$cell = "<TD width='225'><font size='-1'><a href=\"./$rowTypes->ALTNAME-$rowLocs->LOCNAME.htm\">$titleCased</a></font></TD> \n"; //
		...
		$cell = "<TD width='225'><font size='-1'><a href=\"http://www.bostonapartments.com/cli-class.php?TYPE=$rowTypes->TYPE&LOC=$rowLocs->LOCID,0&template=ba-sales&sig=yes&usig=on&htype=ba-sales&tablewidth=830\">$titleCased</a></font></TD> \n"; 

				} elseif ($rowTypes->TYPE =="3") {

		$cell = "<TD width='225'><font size='-1'><a href=\"http://www.bostonapartments.com/cli-class.php?TYPE=$rowTypes->TYPE&LOC=$rowLocs->LOCID,0&template=ba-sales&sig=yes&usig=on&htype=bacomm&tablewidth=830\">$titleCased</a></font></TD> \n"; 

				} elseif ($rowTypes->TYPE =="4") {

		$cell = "<TD width='225'><font size='-1'><a href=\"http://www.bostonapartments.com/cli-class.php?TYPE=$rowTypes->TYPE&LOC=$rowLocs->LOCID,0&template=ba&sig=yes&usig=on&htype=bacomm&tablewidth=830\">$titleCased</a></font></TD> \n"; 

				} elseif ($rowTypes->TYPE =="10") {

		$cell = "<TD width='225'><font size='-1'><a href=\"http://www.bostonapartments.com/cli-class.php?TYPE=$rowTypes->TYPE&LOC=$rowLocs->LOCID,0&template=ba&sig=yes&usig=on&htype=ba-busop&tablewidth=830\">$titleCased</a></font></TD> \n"; 

				} elseif ($rowTypes->TYPE =="11") {

		$cell = "<TD width='225'><font size='-1'><a href=\"http://www.bostonapartments.com/cli-class.php?TYPE=$rowTypes->TYPE&LOC=$rowLocs->LOCID,0&template=ba&sig=yes&usig=on&htype=ba-seniorr&tablewidth=830\">$titleCased</a></font></TD> \n"; 

				} elseif ($rowTypes->TYPE =="12") {

		$cell = "<TD width='225'><font size='-1'><a href=\"http://www.bostonapartments.com/cli-class.php?TYPE=$rowTypes->TYPE&LOC=$rowLocs->LOCID,0&template=ba-sales&sig=yes&usig=on&htype=ba-seniors&tablewidth=830\">$titleCased</a></font></TD> \n"; 

				} elseif ($rowTypes->TYPE =="13") {

		$cell = "<TD width='225'><font size='-1'><a href=\"http://www.bostonapartments.com/cli-class.php?TYPE=$rowTypes->TYPE&LOC=$rowLocs->LOCID,0&template=ba-sales&sig=yes&usig=on&htype=ba-bankowned&tablewidth=830\">$titleCased</a></font></TD> \n"; 


				} else {

		$cell = "<TD width='225'><font size='-1'><a href=\"http://www.bostonapartments.com/cli-class.php?TYPE=$rowTypes->TYPE&LOC=$rowLocs->LOCID,0&template=ba&sig=yes&usig=on&htype=baapt&tablewidth=830\">$titleCased</a></font></TD> \n"; 
				}
