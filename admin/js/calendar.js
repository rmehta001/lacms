    ...
    UI.prototype = {
        ...
        buildHeader: function ($datePicker) {
            var $header = $('<div class="aui-date">\
                ...
                <div class="tomon">\
                <span class="year" id="year">2020</span>-<span class="month" id="month">12</span>-\
                </div>\
        ...
        buildBody: function ($datePicker) {
            ...
            <ol><li>Sun</li><li>Mon</li><li>Tue</li><li>Wed</li><li>Thur</li><li>Fri</li><li>Sat</li></ol></div>\
        ...
        buildBtns: function ($datePicker) {
            ...
            <a href="javascript:;" class="aui-btn" id="btnCancel">Cancel</a>\
            <a href="javascript:;" class="aui-btn" id="btnConfirm">Selete</a>\
            </div>');
            this.btns = $btns;
