...
.text-label {    color: <?php echo $topmenucolor;?>;    font-weight: bold;}
...
<INPUT TYPE="SUBMIT" NAME="SUBMIT" VALUE="View/Edit Listing #" style="font-size:10px;font-family:Verdana,Arial,Helvetica;height:22;width:115" TITLE="View/Edit Listing #"><br><input type="hidden" name="op" value="adlEdit"><input type="hidden" name="return_page" value="<?php echo $page; ?>"><NOBR><?php echo $abv;?>-<input type="text" name="cid" size="8" TITLE="Enter the Listing # to View/Edit"></form></NOBR>
</CENTER>
</td>

<TD valign="middle" ALIGN="LEFT" style="font-size:11px;"><?php if ($user_level>"0") {?><NOBR><a href="<?php echo "$PHP_SELF?op=createLandlord";?>"><img border="0" src="../assets/images/pencil_add.png" TITLE="Click to Create a new Landlord">New Landlord</a></NOBR><BR><NOBR><a href="<?php echo "$PHP_SELF?op=createClient";?>"><img border="0" src="../assets/images/pencil_add.png" TITLE="Click to Create a new Client">New Client</a></NOBR><?php } ?></TD>
<td align="right" valign="top"><?php if ($user_level>"0") {?>
<a href="<?php echo "$PHP_SELF?op=adlEdit&return_page=$page";?>"><img border="0" src="../assets/images/compose.gif" TITLE="Click to Create a new listing"></a><?php }?></td>
</tr>
</table>

<div align="left" style="padding:5px;width:99%;height:17px;background-color:<?php echo $topmenucolor;?>;"><div id="navigation">
<NOBR><a href="<?php echo "$PHP_SELF?op=home";?>" TITLE="Dashboard Stats & Shortcuts to Favorite Clients, Listings & System Updates">&nbsp;Hot List&nbsp;</a>|<a href="<?php echo "$PHP_SELF?op=sel";?>" TITLE="Ad Administration">&nbsp;Ads&nbsp;</a>|<a href="<?php echo "$PHP_SELF?op=listings&vid=$listview&listing_filter_display=$listsearch&availFilter=$listactive&filterChange=1";?>" TITLE="Full Listing & Ad Database System">&nbsp;Listings&nbsp;</a>|<?php if ($user_level>"0.5") {?><a href="<?php echo "$PHP_SELF?op=manageLandlord";?>" TITLE="Owners, Landlords & Sellers">&nbsp;Landlords&nbsp;</a>|<?php }?><a href="<?php echo "$PHP_SELF?op=manageClients";?><?php if ($pref_all_clients==1) {?>&clients_filter=1&clients_filter_name_first=&clients_filter_name_last=&clients_filter_price_min=&clients_filter_price_max=&clients_filter_type=0&clients_filter_phone=&clients_filter_email=&clients_filter_status_client=1<?php } ?>" TITLE="Clients: Buyers & Renters">&nbsp;Clients&nbsp;</a>|<a href="http://www.bostonapartments.com/contacts" target="_Contacts" TITLE="Contacts other than Clients & Landlords">&nbsp;Contacts&nbsp;</a>|<a href="<?php echo "$PHP_SELF?op=openhouse";?>" TITLE="Manage Your Open House Listings & Ads">&nbsp;Open Houses&nbsp;</a>|<a href="<?php echo "$PHP_SELF?op=cobroke-menu";?>" TITLE="Landlord Listings & Co-Brokes from Other Agencies | Manage Co-Broke Settings">&nbsp;Co-Brokes&nbsp;</a>|<a href="<?php echo "$PHP_SELF?op=mail_all_agents";?>" TITLE="Email Everyone @ the Office">&nbsp;Email Office&nbsp;</a>|<a href="<?php echo "$PHP_SELF?op=tools";?>" TITLE="Mortgage Calculator | Real Estate Forms | Email Extractor | Newsletter Management | Email Reminder | SS# Check | Reports | Chat | Forums">&nbsp;Tools&nbsp;</A>|<a href="<?php echo "$PHP_SELF?op=editPrefs";?>" TITLE="Password | Colors | Agent Preferences & Settings">&nbsp;Preferences&nbsp;</a>|<a href="<?php echo "$PHP_SELF?op=help";?>" TITLE="Click for Help on Everything">&nbsp;Help&nbsp;</a><?php if (($isAdmin) OR ($user_level >= "10")) {?>|<a href="<?php echo "$PHP_SELF?op=admin";?>" TITLE="Manage Agents, Templates, Backups & more">&nbsp;Admin&nbsp;</a><?php }?>|<a href="../logout.php">&nbsp;Logout&nbsp;</a></NOBR></DIV></div>
</div>
<CENTER>
<!--End Top box-->
<?php 
