...
//                                                $filters[$i] = " ($preFilter[1]$preFilter[2]'%$preFilter[0]%') ";
	...
	if($sourcemls=="$grid") {
		...
		switch ($numFilters) {
			...
			case 0:
				$WHERE = " WHERE ((CLI!='1075' AND CLI!='1041' AND CLI!='$grid' AND CLI!='392') AND (COBROKE='1' AND STATUS_ACTIVE='1')) $userFilterStr $activeFilterStr $availFilterStr";
				break;
			case 1:
				$WHERE = " WHERE " . $filters[0] . " AND ((CLI!='1075' AND CLI!='1041' AND CLI!='$grid' AND CLI!='392') AND (COBROKE='1' AND STATUS_ACTIVE='1')) $userFilterStr $activeFilterStr $availFilterStr";
				break;
			default:
				$WHERE = " WHERE ";
				for ($i=0;$i<=($numFilters-1);$i++) {
				...
				$WHERE .= " ((CLI!='1075' AND CLI!='1041' AND CLI!='$grid' AND CLI!='392') AND (COBROKE='1' AND STATUS_ACTIVE='1')) $userFilterStr $activeFilterStr $availFilterStr";
				break;
		}
