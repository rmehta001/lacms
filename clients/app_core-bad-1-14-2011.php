...
session_register ("mls_town_pref");
...
if ($needOptions) {
	...
	$quStrFavLocs = "SELECT * FROM FAVLOC INNER JOIN LOC ON FAVLOC.LOC=LOC.LOCID WHERE UID='$uid' ORDER BY SCORE DESC LIMIT 15";
