<?php
		...
		/*///////////////////////////////////////////////////////////////////////////
		//bstapts client interface core 3.0 Copyright 2011 BostonApartments.com //
		//////////////////////////////////////////////////////////////////////////*/
...
//                                                $filters[$i] = " ($preFilter[1]$preFilter[2]'%$preFilter[0]%') ";
	...
	if($sourcemls=="$grid") {
		...
		switch ($numFilters) {
			...
			case 0:
				$WHERE = " WHERE ((CLI='$grid') OR (CLI!='$grid' AND COBROKE='1' AND STATUS_ACTIVE='1')) $userFilterStr $activeFilterStr $availFilterStr";			break;
			case 1:
				$WHERE = " WHERE " . $filters[0] . " AND ((CLI='$grid') OR (CLI!='$grid' AND COBROKE='1' AND STATUS_ACTIVE='1')) $userFilterStr $activeFilterStr $availFilterStr";
				break;
			default:
				$WHERE = " WHERE ";
				for ($i=0;$i<=($numFilters-1);$i++) {
				...
				$WHERE .= " ((CLI='$grid') OR (CLI!='$grid' AND COBROKE='1' AND STATUS_ACTIVE='1')) $userFilterStr $activeFilterStr $availFilterStr";
				break;
		}
