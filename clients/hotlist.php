...
<div class="row">
  <div class="col-3">
    ...
    <a class="nav-link" id="contact-tab" href="<?php echo "$PHP_SELF?op=agentreport"; ?>"><i class="fa fa-file"></i> Agent Activity Report</a>
    <a class="nav-link" id="contact-tab" href="<?php echo "$PHP_SELF?op=showingsAgent"; ?>"><i class="fa fa-file-alt"></i> Agent Showing History</a>
...
if (isset($_SESSION['show_hot_list'])) {
    ...
    ?>
			  ...
			  <div class="col-lg-12">
				  <table class="table table-borderers cell-color ">
					  <tr>
					  <?php
        ...
        while ($rowGetHotListAd = mysqli_fetch_object($quGetHotListAd)) {
            ?>
                ...
                echo "<a href='$PHP_SELF?op=activate&cid=$rowGetHotList->ITEM_ID&return_page=hotlist'><img border='0' vspace='0' hspace='0' width='14' height='14' src='../assets/images/inact.jpg'></a>";
                                            ...
                                            <a href="<?php echo "$PHP_SELF?op=showinghistoryunit&cid=$rowGetHotList->ITEM_ID"; ?>" TITLE="Showing History" target="_sh<?php echo $rowGetHotListAd->CID; ?>"><img border="0" hspace="0" vspace="0" width="16" height="16" src="../assets/images/showings-history.jpg" TITLE="Unit Showing History" ALT="Showing History for Unit"></A>
                                        ...
                                        <a href="<?php echo "https://www.BostonApartments.com/plugin/?ad=$rowGetHotList->ITEM_ID&cli=$grid&uid=$uid\" target=\"_CL" . $rowGetHotList->ITEM_ID . "\""; ?>"><img width="16" height="16" border="0" vspace="0" hspace="0" src="../images/icons/cl.gif" TITLE="Post to CL"></A>
...
//                    echo "<a href='$PHP_SELF?op=activate&cid=$rowGetHotList->ITEM_ID&return_page=hotlist'><img border='0' vspace='0' hspace='0' width='14' height='14' src='../assets/images/inact.jpg'></a>";
                    echo "<a href='$PHP_SELF?op=activate&cid=$rowGetHotList->ITEM_ID&return_page=hotlist'><i class='fa fa-check-circle small' aria-hidden='true'></i></a>";
