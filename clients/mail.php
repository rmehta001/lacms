...
$client_list = isset($_POST['client_list']);
...
if (isset($client_list) AND ($to)) {
$to .= ",$client_list";
} elseif (isset($client_list) AND (!$to)) {
$to .= "$client_list";
}
...
if (isset($ok)) {
  ...
  echo "<p>Your email has been sent to:<BR>$to </p> <a href=\"#\" onClick=\"history.go(-2)\">Click to go Back to the BostonApartments.com Database</a>";
