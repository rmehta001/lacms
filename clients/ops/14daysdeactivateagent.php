...
$quStrGet14days = "UPDATE CLASS SET STATUS='STO', STATUS_ACTIVE='0', STATUS_VACANT='0', `MOD`='".$now."', MODBY='".$handle."' where ((`MOD` < DATE_SUB(CURDATE() ,INTERVAL 14 DAY)) AND `CLI`='".$grid."')" ;
