...
if (!isset ($_GET['SortDir'])) {
	...
	if (isset($_SESSION["clients_filter_phone"])) {
...
$clients_where .= " and LEADSAFE!=\"clients_leadsafe\"";
	...
	if (isset($_SESSION["clients_filter_pets"])) {
$clients_where .= " and PETS_PREF>=\"2\"";
}



	if (isset($_SESSION["$clients_filter_beds"])) {
...
$clients_where .= " and (ROOMS_PREF>=\"10\" AND ROOMS_PREF<\"11\")";
	...
	if (isset($_SESSION["$clients_filter_baths"])) {
