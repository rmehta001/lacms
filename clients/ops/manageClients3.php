...
//BEGIN manageClients //
	...
	session_register("clients_filter_source");
	session_register("clients_filter_subtype");
	session_register ("clients_filter_building_pref");
	session_register ("clients_leadsafe");
...
if (!$HTTP_GET_VARS['SortDir']) {
	...
	if ($_GET['clients_filter']) {
		...
		$clients_filter_source = $_GET['clients_filter_source'];
		$clients_filter_agent = $_GET['clients_filter_agent'];
		$clients_filter_subtype = $_GET['clients_filter_subtype'];
		$clients_filter_building_pref = $_GET['clients_filter_building_pref'];
		$clients_leadsafe = $_GET['clients_leadsafe'];
