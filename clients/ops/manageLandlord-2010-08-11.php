...
//BEGIN manageLandlord //
	...
	session_register("landlords_filter_short_name");
	session_register("landlords_filter_home_name_first");
	session_register("landlords_filter_home_name_last");
	...
	if ($_GET['landlords_filter']) {
		$landlords_filter_short_name = $_GET['landlords_filter_short_name'];
		$landlords_filter_home_name_first = $_GET['landlords_filter_home_name_first'];
		$landlords_filter_home_name_last = $_GET['landlords_filter_home_name_last'];
	...
	if ($landlords_filter_short_name) {
		$landlords_where .= " and SHORT_NAME like \"%$landlords_filter_short_name%\"";
	}


if ($landlords_filter_home_name_first) {
		$landlords_where .= " and HOME_NAME_FIRST like \"$landlords_filter_home_name_first%\" OR GRID=$grid AND HOME_SPOUSE_FIRST like \"$landlords_filter_home_name_first%\"";
	}


if ($landlords_filter_home_name_last) {
		$landlords_where .= " and HOME_NAME_LAST like \"$landlords_filter_home_name_last%\" OR GRID=$grid AND HOME_SPOUSE_LAST like \"$landlords_filter_home_name_last%\"";
...
$landlords_where .= " and LL_EMAIL like \"%$landlords_filter_email%\" OR GRID=$grid AND OFF_EMAIL like \"%$landlords_filter_email%\" OR GRID=$grid AND LLNOTES like \"%$landlords_filter_email%\"";

}	

	if ($landlords_filter_off_name) {
$landlords_where .= " and OFF_NAME like \"$landlords_filter_off_name%\"";
