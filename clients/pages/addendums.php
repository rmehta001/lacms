...
<img border="0" src="../assets/images/additionaladdenda.jpg" HEIGHT="54" WIDTH="38">
</TD>
<TD VALIGN="BOTTOM" ALIGN="CENTER">
<h3><NOBR>ADDITIONAL ADDENDA &amp; DOCUMENTS</NOBR></H3>
</TD>
<TD VALIGN="BOTTOM" ALIGN="CENTER">
<img border="0" src="../assets/images/additionaladdenda.jpg" HEIGHT="54" WIDTH="38">
</TD></TR></TABLE>
	...
	<table border="1" cellspacing="0" cellpadding="5" BGCOLOR="<?php echo $pagebgcolor;?>" BORDERCOLOR="#000000" WIDTH="450">
	<tr>
	<td>
...
<?php
	...
	$quGetLandlordA = mysqli_query($dbh, $quStrGetLandLordA) or die(dieNice("Sorry, couldn't find that landlord's additional addenda", "E-Addendum"));
...
<A HREF=\"../clients/documents/$rowGetLandlordA->PID.$rowGetLandlordA->EXT\" target=\"_new\">View/Print</a></TD><TD align=\"center\">
