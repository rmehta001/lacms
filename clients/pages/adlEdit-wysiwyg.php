...
<?php $adBody = ($rowGetAd->BODY) ? $rowGetAd->BODY : "";?>

<textarea name="BODY" id="simpleBODY" cols="100" rows="7" style="height: 200px; width: 500px;background-color:#FFFFFF;"  ><?php echo $adBody;?></textarea>
<script language="JavaScript">
   generate_wysiwyg('simpleBODY');
 </script>
...
<span style="font-size:10px;">
<a href="<?php echo "$PHP_SELF?op=adlEdit&cid=$rowGetAd->CID&return_page=sel&return_page_rid=$rowGetAd->CID";?>">CLICK HERE to not use a WYSIWYG editor</A>
</SPAN>
...
<textarea name="BODY_ALT" id="BODY_ALT" cols="100" rows="7" value="<?php echo htmlspecialchars($rowGetAd->BODY_ALT);?>" style="height: 200px; width: 500px;background-color:#FFFFFF;"><?php echo $rowGetAd->BODY_ALT ;?></textarea>
<script language="JavaScript">
   generate_wysiwyg('BODY_ALT');
 </script>
...
<textarea name="BODY_AGENT" id="BODY_AGENT" cols="100" rows="7" value="<?php echo htmlspecialchars($rowGetAd->BODY_AGENT);?>" style="height: 200px; width: 500px;background-color:#FFFFFF;"><?php echo $rowGetAd->BODY_AGENT ;?></textarea>
<script language="JavaScript">
   generate_wysiwyg('BODY_AGENT');
 </script>
...
<LI><a href="https://www.BostonApartments.com/homepage.php?cli=<?php echo $grid;?>&ad=<?php echo $cid;?>&amp;uid=<?php echo $uid;?>" target="_NEW">Preview Ad</a><BR>
...
<LI><a href="https://www.BostonApartments.com/kijijipost.php?cli=<?php echo $rowGetAd->CLI;?>&amp;ad=<?php echo $cid;?>&amp;uid=<?php echo $uid;?>" target="_NEW">Post To eBay Classifieds</A><BR>
...
<textarea name="BODY" id="fullBODY" cols="100" rows="7" style="height: 200px; width: 500px;background-color:#FFFFFF;"  ><?php echo $adBody;?></textarea>
<script language="JavaScript">
   generate_wysiwyg('fullBODY');
 </script>
