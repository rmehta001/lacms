<!--Begin adlEdit -->
<FONT SIZE="-4"><br></FONT>
<div align="left" style="padding:0px;margin:px;border:1px solid black;width:1000;background-color:#FFFFFF;font-family:Verdana,Arial,Helvetica;font-size:14px;color:black;">
...
<?php if ($user_level>"0" AND ($rowGetAd->CLI=="$grid" OR $rowGetAd->CLI=="1075")) {?><a href="<?php echo "$PHP_SELF?op=copy&cid=$cid";?>"><span style="" >Copy</span><a> | <a href="<?php echo "$PHP_SELF?op=hot_list_add&item_type=1&item_id=$rowGetAd->CID&return_page=sel&return_page_rid=$rowGetAd->CID";?>"><span style="" ><img width="16" height="16" border="0" vspace="0" hspace="0" src="../assets/images/hot.gif" alt="Add to Hot List" title="Add to Hot List"></span></a> | <?php }?> <a href="<?php echo "$PHP_SELF?op=mail_listing&cid=$rowGetAd->CID";?>"><IMG src=../images/icons/email.gif BORDER=0 HEIGHT=15 WIDTH=22 alt="Email Listing" title="Email Listing"></A> | <a href="<?php echo "$PHP_SELF?op=manageClients&clients_filter=1&clients_filter_agent=".$uid."&clients_filter_type=".$rowGetAd->TYPE."&clients_filter_loc_pref=".$rowGetAd->LOC."&clients_filter_status_client=1";?>"><img width="16" height="16" border="0" vspace="0" hspace="0" src="../assets/images/matchlistings.gif" alt="Match Listing to Clients" title="Match Listing to Clients"></a> <?php if ($user_level>"0" AND $rowGetAd->CLI=="$grid") {?><?php if($rowGetAd->LID) {?> | <a href="<?php echo "$PHP_SELF?op=editLandlord&lid=$rowGetAd->LANDLORD";?>" target="_EL<?php echo "$rowGetAd->LANDLORD";?>"><img border=0 src="../images/icons/edit.gif" alt="edit">Landlord</a><?php }?> | <?php if ($user_level>0 AND $rowGetAd->CLI=="$grid") { ?> <A HREF="<?php echo "$PHP_SELF?op=openhouse-add&CID=$rowGetAd->CID&return_page=adlEdit";?>"><IMG SRC="../assets/images/openhouse.jpg" height="16" WIDTH="16" BORDER="0">Create Open House</A> | <?php } ?> <?php if ($rowGetAd->CLI=="$grid") { ?><A HREF="<?php echo "$PHP_SELF?op=createshowing&cid=$rowGetAd->CID&return_page=adlEdit";?>"><img border="0" hspace="0" vspace="0" width="16" height="16" src="../assets/images/showings.jpg" TITLE="Create Showing" ALT="Create Showing"></A> | <A HREF="<?php echo "$PHP_SELF?op=showinghistoryunit&cid=$rowGetAd->CID&return_page=adlEdit";?>"><img border="0" hspace="0" vspace="0" width="16" height="16" src="../assets/images/showings-history.jpg" TITLE="Showing History" ALT="Showing History"></A><?php }?> | <?php }?> <a href="javascript:popUpPrintOut('./printout_agent.php?cid=<?php echo $rowGetAd->CID;?>');"><img src="../assets/images/agent-ss.gif" vspace="0" hspace="0" border="0" height="18" width="18" alt="Agent Show Sheet" title="Agent Show Sheet <?php if ($rowGetAd->SHOW_INSTRUCT) { echo  " - ".$rowGetAd->SHOW_INSTRUCT; }?><?php if ($rowGetAd->LISTING_NOTES) { echo  " - ".$rowGetAd->LISTING_NOTES; }?>"></a> <?php if ($rowGetAd->PIC>0) { ?>  | <a href="javascript:popUpPrintOut('./printout_agent_pic.php?cid=<?php echo $rowGetAd->CID;?>');"><img src="../assets/images/agent-ss-pic.gif" vspace="0" hspace="0" border="0" height="18" width="18" alt="Agent Show Sheet with Pictures" title="Agent Show Sheet with Pictures <?php if ($rowGetAd->SHOW_INSTRUCT) { echo  " - ".$rowGetAd->SHOW_INSTRUCT; }?><?php if ($rowGetAd->LISTING_NOTES) { echo  " - ".$rowGetAd->LISTING_NOTES; }?>"></a><?php  } ?> | <a href="javascript:popUpPrintOut('./printout_client.php?cid=<?php echo $rowGetAd->CID;?>');"><img src="../assets/images/doc.gif" vspace="0" hspace="0" border="0" height="18" width="18" alt="Client Printout" title="Client Printout"></a><?php if ($rowGetAd->PIC>0) { ?> | <a href="javascript:popUpPrintOut('./printout_client_pic.php?cid=<?php echo $rowGetAd->CID;?>');"><img src="../assets/images/doc-pic.gif" vspace="0" hspace="0" border="0" height="18" width="18" alt="Client Printout with Pictures" title="Client Printout with Pictures"></a><?php } ?> 

<?php if (($user_level>="3") or ($user_level<"3" AND $rowGetAd->STATUS=="ACT") ) { ?>
...
<?php if ($rowGetAd->CLI=="1075") { echo "<FONT COLOR=BLUE><FONT SIZE='+1'><B>MLS LISTING</B></FONT><BR><FONT COLOR=#FF0000>This is MLS Listing # ".$rowGetAd->EXTERNALID. "</FONT></FONT><BR>"; }?>
...
<?php if ($rowGetAd->CLI!="1075" AND $rowGetAd->CLI!=$grid) { echo "<FONT COLOR=BLUE SIZE='+1'><B>BOSTONAPARTMENTS.COM NETWORK LISTING</B></FONT><BR>";
...
if ($rowGetAd->PIC !="0" AND $rowGetAd->PIC >= "2") { echo $rowGetAd->PIC . "&nbsp;"; }
echo "Pics</CENTER>";
...
echo "<CENTER><a href=https://www.BostonApartments.com/homepage-MLS.php?cli=$rowGetAd->CLI&ad=$rowGetAd->CID&uid=$rowGetAd->UID target=_NEW>$thumb</A><BR>$rowGetAd->EXTERNALPIC_NUM";
 if ($rowGetAd->EXTERNALPIC_NUM !="0" AND $rowGetAd->EXTERNALPIC_NUM >= "2") { echo " Additional "; }

echo " Pics</CENTER>";
}


if ($rowGetAd->CLI=="$grid" AND CSOURCE>'0') {
echo "<CENTER><a href=https://www.BostonApartments.com/homepage.php?cli=$rowGetAd->CLI&ad=$rowGetAd->CID&uid=$rowGetAd->UID target=_NEW>$thumb</A><BR>";
...
<div id="simpleArea" style="width:965px; margin:8px; padding:8px; background-color:<?php echo $pagebgcolor;?>; border:1px solid black; display:<?php echo $display;?>;">
...
<?php if (($user_level>"0" AND $rowGetAd->LOCKED=="0") OR ($rowGetAd->LOCKED=="1" and $user_level>="4") OR ((!($cid)) and $user_level>"0")    ) {
...
if ($rowGetAd->CSOURCE=="0" AND $rowGetAd->CLI=="$grid") {
	?>

<!-- <span onClick="<?php echo $SaveAd;?>">
<a href="<?php // echo $PHP_SELF;?>?op=dateavailablenowdo&amp;cid=<?php // echo $rowGetAd->CID;?>&amp;grid=<?php  // echo $grid;?>&amp;next_contact=<?php // echo $rowGetAd->AVAIL;?>" target="_datechange"><FONT SIZE="-3" COLOR="green">Make Now</FONT></A>
</SPAN> -->
...
<option value="1" <?php if ($rowGetAd->SYNDICATION=='1') { echo " selected"; }?>>Yes</option>
<option value="0" <?php if ($rowGetAd->SYNDICATION=='0') { echo " selected"; }?>>No</option>
</select>
...
<input type="text" size="100" name="AD_TITLE" id="simpleAD_TITLE" value="<?php echo $rowGetAd->AD_TITLE;?>">

</TD></TR><TR><TD>

<span style="font-size:10px;">Ad Body:<BR></SPAN>
<?php $adBody = ($rowGetAd->BODY) ? $rowGetAd->BODY : "Type your ad here.";?>
<textarea name="BODY" id="simpleBODY" cols="100" rows="7" onFocus=clear_textbox() value="Type your ad here."><?php echo $adBody;?></textarea>
</TD></TR></TABLE>
...
<span style="font-size:10px;" onClick="<?php echo $photoClick;?>">
...
<span style="font-size:10px;">Alternative HTML Ad Body for the office: (<I>This will show in the more details and other places that the regular line ads above can be replaced.</I>) <a href="<?php echo "$PHP_SELF?op=adlEdit-wysiwyg&cid=$rowGetAd->CID&return_page=sel&return_page_rid=$rowGetAd->CID";?>"><span style="font-size:10px;">Use WYSIWYG editor</SPAN></A>
</SPAN><BR>
...
<NOBR>
<input type="text" size="40" name="YOUTUBEURL" id="simpleYOUTUBEURL" value="<?php echo $rowGetAd->YOUTUBEURL;?>">  &nbsp;&nbsp; <span style="font-size:8px;"><A HREF="http://www.youtube.com/my_videos_upload" target="_NEW">Upload to <IMG SRC="https://www.BostonApartments.com/images/youtube.gif" BORDER="0"></A></SPAN>
</NOBR>
</TD></TR><TR><TD COLSPAN=2 VALIGN=TOP>
...
<span style="font-size:10px;"><NOBR>
<input type="checkbox" value=1 name="LUXURY_APT" <?php if ($rowGetAd->LUXURY_APT>0) {
echo " checked "; } ;?>>Luxury Apt. &nbsp; | &nbsp; <input type="checkbox" value=1 name="FEATURED" <?php if ($rowGetAd->FEATURED>0) {
...
Change Agent:<br>
	<select name="UID" STYLE="Background-Color : #FFFFFF">
		...
		<option value="<?php echo $rowGetUsers->UID;?>"<?php if ($rowGetAd->UID==$rowGetUsers->UID) { echo "selected "; }elseif ($rowGetAd->UID==NULL AND $rowGetUsers->UID==$uid) { echo "selected "; }?>><?php echo $rowGetUsers->HANDLE; ?></option>
		<?php } ?> 
	</select></td>
<?php }?>
</DIV>
...
<LI><A HREF="https://mbta.com/transit-near-me?_utf8=✓&location%5Baddress%5D=<?php echo $rowGetAd->STREET_NUM ."". $rowGetAd->STREET. " ". $rowGetAd->ZIP;?>" target="_NEW">MBTA</A>
<LI><A HREF="http://maps.google.com/maps?hl=en&um=1&ie=UTF-8&q=laundromat&near=<?php echo $rowGetAd->STREET_NUM;?>+<?php echo $rowGetAd->STREET;?>+<?php echo $rowGetAd->ZIP;?>&fb=1&sa=X&oi=local_group&resnum=1&ct=image" target="_NEW">Laundry</A><BR>
<LI>
<A HREF="http://maps.google.com/maps?hl=en&um=1&ie=UTF-8&q=supermarket&near=<?php echo $rowGetAd->STREET_NUM;?>+<?php echo $rowGetAd->STREET;?>+<?php echo $rowGetAd->ZIP;?>&fb=1&sa=X&oi=local_group&resnum=1&ct=image" target="_NEW">Supermarket</A><BR>
<LI><A HREF="http://maps.google.com/maps?hl=en&um=1&ie=UTF-8&q=convenience+store&near=<?php echo $rowGetAd->STREET_NUM;?>+<?php echo $rowGetAd->STREET;?>+<?php echo $rowGetAd->ZIP;?>&fb=1&sa=X&oi=local_group&resnum=1&ct=image" target="_NEW">Convenience Store</A></NOBR><BR>
...
<LI><a href="https://www.BostonApartments.com/digpost.php?cli=<?php echo $rowGetAd->CLI;?>&amp;ad=<?php echo $cid;?>&amp;uid=<?php echo $uid;?>" target="_NEW">Post To Dig/Backpage.com</A><BR>
...
<div id="fullArea" style="width:965px; margin:8px; padding:8px; background-color:<?php echo $pagebgcolor;?>; border:1px solid black;display:<?php echo $display;?>;">
...
Priority:<input type="hidden" name="PRIORITY" value="0"><input id="PRIORITY" type="checkbox" value="1" TITLE="Check to mark it a Priority Listing" name="PRIORITY" <?php if ($rowGetAd->PRIORITY=="1") { echo " checked "; } ?>>
...
Locked:<input type="hidden" name="LOCKED" value="0"><input id="LOCKED" type="checkbox" value="1" TITLE="Check to LOCK Listing for Admin" name="LOCKED" <?php if ($rowGetAd->LOCKED=="1") { echo " checked "; } ?>>
<?php } else { if ($rowGetAd->LOCKED=="1") { echo "<FONT COLOR=RED>LOCKED</FONT>";
 }} ?>
...
<td align="left" height="30"> &nbsp;</td>
			...
			<td valign="top">
				...
				<tr><td align="right" class="controltext">Lead Safe</td><td align="left"><input type="checkbox" name="FEATURES_DELEADED" value="1" <?php if ($rowGetAd->FEATURES_DELEADED) { echo "checked"; } ?> ></td></tr>
				...
				<tr><td align="right" class="controltext">Intercom</td><td align="left"><input type="checkbox" name="FEATURES_INTERCOM" value="1" <?php if ($rowGetAd->FEATURES_INTERCOM) { echo "checked"; } ?> ></td></tr>
			...
			<td valign="top">
				...
				<tr><td align="right" class="controltext">Bay Windows</td><td align="left"><input type="checkbox" name="FEATURES_BAYWINDOWS" value="1" <?php if ($rowGetAd->FEATURES_BAYWINDOWS) { echo "checked"; } ?> ></td></tr>
			...
			<td valign="top">
				...
				<tr><td align="right" class="controltext"><NOBR>Stainless Apps</NOBR></td><td align="left"><input type="checkbox" name="FEATURES_STAINLESS" value="1" <?if ($rowGetAd->FEATURES_STAINLESS) { echo "checked"; } ?> ></td></tr>
				<input type="hidden" name="FEATURES_GRANITEC" value="0">
				<tr><td align="right" class="controltext"><NOBR>Granite Counters</NOBR></td><td align="left"><input type="checkbox" name="FEATURES_GRANITEC" value="1" <?if ($rowGetAd->FEATURES_GRANITEC) { echo "checked"; } ?> ></td></tr>
			...
			<td valign="top">
				...
				<tr><td align="right" class="controltext"><NOBR>Ceiling Fan</NOBR></td><td align="left"><input type="checkbox" name="FEATURES_CEILINGFAN" value="1" <?if ($rowGetAd->FEATURES_CEILINGFAN) { echo "checked"; } ?> ></td></tr>
				...
				<tr><td align="right" class="controltext"><NOBR>Cable TV</NOBR></td><td align="left"><input type="checkbox" name="FEATURES_CABLETV" value="1" <?if ($rowGetAd->FEATURES_CABLETV) { echo "checked"; } ?> ></td></tr>
...
<span style="font-size:12px;"><B>Amenities:</B></span>
			...
			<td valign="top">
				...
				<tr><td align="right" class="controltext"><NOBR>Playground</NOBR></td><td align="left"><input type="checkbox" name="AMENITIES_PLAYGROUND" value="1" <?php if ($rowGetAd->AMENITIES_PLAYGROUND) { echo "checked"; } ?> ></td></tr>
				
				<input type="hidden" name="AMENITIES_BASKETBALL" value="0">
				<tr><td align="right" class="controltext"><NOBR>Basketball</NOBR></td><td align="left"><input type="checkbox" name="AMENITIES_BASKETBALL" value="1" <?php if ($rowGetAd->AMENITIES_BASKETBALL) { echo "checked"; } ?> ></td></tr>
			...
			<td  valign="top">
				...
				<tr><td align="right" class="controltext">Bike Storage</td><td align="left"><input type="checkbox" name="AMENITIES_BIKEROOM" value="1" <?php if ($rowGetAd->AMENITIES_BIKEROOM) {echo "checked"; }?> ></td></tr>
				
				<input type="hidden" name="AMENITIES_BBQ" value="0">
				<tr><td align="right" class="controltext">BBQ</td><td align="left"><input type="checkbox" name="AMENITIES_BBQ" value="1" <?php if ($rowGetAd->AMENITIES_BBQ) { echo "checked"; } ?> ></td></tr>
			...
			<td  valign="top">
				...
				<tr><td align="right" class="controltext">Zip Car</td><td align="left"><input type="checkbox" name="AMENITIES_ZIPCAR" value="1" <?php if ($rowGetAd->AMENITIES_ZIPCAR) { echo "checked"; } ?> ></td></tr>
...
<TD>
<span style="font-size:10px;">Frontage:<BR></span>
	<input name="FRONTAGE" type="text" size="8" value="<?php echo $rowGetAd->FRONTAGE;?>">
...
$<input type="text" id="ASSESSMENT" name="ASSESSMENT" value="<?php echo $rowGetAd->ASSESSMENT;?>" SIZE=12>
			...
			<span style="font-size:10px;">Tax Year:</SPAN><BR>
<input type="text" id="TAX_YEAR" name="TAX_YEAR" value="<?php echo $rowGetAd->TAX_YEAR;?>" SIZE=5>
...
<a href="<?php echo "$PHP_SELF?op=adlEdit-wysiwyg&cid=$rowGetAd->CID&return_page=sel&return_page_rid=$rowGetAd->CID";?>">Use WYSIWYG editor</A>
</SPAN>
</TD><TD >

 <input type="text" size="100" name="AD_TITLE" id="fullAD_TITLE" value="<?php echo $rowGetAd->AD_TITLE;?>" onChange="syncMeSelect2('fullAD_TITLE', 'simpleAD_TITLE');"><BR>
<P>

<textarea name="BODY" id="fullBODY" cols="100" rows="7" onFocus="clear_textbox();" value="Type your ad here." onChange="syncMeSelect2('fullBODY', 'simpleBODY');"><?php echo $adBody;?></textarea>
</TD></TR></TABLE>
</TD></TR></TABLE>
...
<a href="<?php echo $PHP_SELF;?>?op=editllnote&amp;llid=<?php echo $rowGetAd->LANDLORD;?>" target="_editlnote"><img border=0 src="../images/icons/edit.gif" alt="edit" title="edit" vspace="0" hspace="0" ></a><BR></span><textarea rows="5" cols="42"><?php echo $rowGetAd->LLNOTES;?></textarea>
</TD></TR></TABLE>
<TABLE><TR><TD>
...
<input type="input" name="TENANT_PHONE" value="<?php echo $rowGetAd->TENANT_PHONE;?>" size="18">
		...
		<table>
		<tr>
			<td height="40" ><span style="font-size:10px;">Additional Office Notes (for this unit):<BR></span><textarea name="LISTING_NOTES" rows="6" cols="40"><?php echo $rowGetAd->LISTING_NOTES;?></textarea></td>
		</tr>
		</table>
</TD>
...
<tr><td colspan=2>
<span style="font-size:10px;"><NOBR>Source:

<select name="CSOURCE" STYLE="Background-Color : #FFFFFF">                                                      
				<option value="0" <?php if ($rowGetAd->CSOURCE=="0") { echo " selected "; } ?>>Our Office</option>
				<option value="1" <?php if ($rowGetAd->CSOURCE=="1") { echo " selected "; } ?>>YGL</option>
				<option value="2" <?php if ($rowGetAd->CSOURCE=="2") { echo " selected "; } ?>>RJ</option>
			</select> 
</NOBR></SPAN></td></tr>
...
<TABLE> <tr>
			<td height="30" ><span style="font-size:10px;">Month:<BR></span><select name="doffmMonth" STYLE="Background-Color : #FFFFFF">
				<option value="--">--</option>                                                      
			...
			<td height="30" width="1">&nbsp;</td>
			<td height="30" width="20"><span style="font-size:10px;">Day:<BR></span><select name="doffmDay" STYLE="Background-Color : #FFFFFF">
				<option value="--">--</option>
				<?php for ($i=1;$i<=31;$i++) {
					if ($i<=9) {
						$j = "0".$i;
			...
			<td height="30" width="1">&nbsp;</td>
			<td height="30" width="20"><span style="font-size:10px;">Year:<BR></span><select name="doffmYear" STYLE="Background-Color : #FFFFFF">
				<option value="--">--</option>
				<?php 
				$thisYear = date ("Y");
				for ($i=0;$i<=4;$i++) {?>
