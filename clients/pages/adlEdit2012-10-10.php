...
echo "<center><h3><FONT COLOR=#FF0000>This is YGL Listing # ".$rowGetAd->EXTERNALID. "</FONT></h3></CENTER>";
		...
		} elseif (($rowGetAd->STATUS =="STO") AND ($rowGetAd->CLI != "1075")) {
...
if ($rowGetAd->CLI=="1075") {
echo "<a href=http://www.bostonapartments.com/homepage-MLS.php?cli=$rowGetAd->CLI&ad=$rowGetAd->CID&uid=$rowGetAd->UID target=_NEW>$thumb</A> $rowGetAd->PIC pics";
} else {
echo "<a href=http://www.bostonapartments.com/homepage.php?cli=$rowGetAd->CLI&ad=$rowGetAd->CID&uid=$rowGetAd->UID target=_NEW>$thumb</A> $rowGetAd->PIC pics";
}
