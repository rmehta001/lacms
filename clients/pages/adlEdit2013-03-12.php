...
echo "<CENTER><a href=http://www.bostonapartments.com/homepage-MLS.php?cli=$rowGetAd->CLI&ad=$rowGetAd->CID&uid=$rowGetAd->UID target=_NEW>$thumb</A><BR>$rowGetAd->EXTERNALPIC_NUM";
...
echo "<CENTER><a href=http://www.bostonapartments.com/homepage.php?cli=$rowGetAd->CLI&ad=$rowGetAd->CID&uid=$rowGetAd->UID target=_NEW>$thumb</A><BR>";
echo "Pics</CENTER>";
}
...
?>
<span onClick="<?php echo $SaveAd;?>">
<a href="<?php echo $PHP_SELF;?>?op=dateavailablenowdo&amp;cid=<?php echo $rowGetAd->CID;?>&amp;grid=<?php echo $grid;?>&amp;next_contact=<?php echo $rowGetAd->AVAIL;?>"><FONT SIZE="-3" COLOR="green">Make Now</FONT></A></SPAN>
<?php } }
?>
</NOBR><br>
