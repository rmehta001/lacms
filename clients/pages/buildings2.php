...
if ($test >0) {
echo "<img border='0' vspace='0' hspace='0' width='16' height='16' src='../assets/images/act.gif'>";
} else {
echo "<img border='0' vspace='0' hspace='0' width='16' height='16' src='../assets/images/inact.jpg'>";
}

echo "</TD><TD VALIGN=TOP>";

$quStrGetstatusa = "SELECT STATUS_ACTIVE FROM CLASS WHERE CLI='$grid' AND LANDLORD='$lid' AND STREET='$rowBuildings->STREET' AND STREET_NUM='$rowBuildings->STREET_NUM' AND STATUS_ACTIVE='0' LIMIT 1";
$result2 = mysqli_query($dbh, $quStrGetstatusa);
$test2 = mysqli_num_rows($result2);
if ($test2 >0) {
echo "<img src=\"../assets/images/icons/a.jpg\" border=0 height=16 width=16 alt=\"available\" title=\"Available\">";
} else {
echo "<img src=\"../assets/images/icons/u.jpg\" border=0 height=16 width=16 alt=\"unavailable\" title=\"Unavailable\">";
}
