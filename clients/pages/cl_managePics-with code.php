...
<?php
echo "<input type=\"button\" STYLE=\"Background-Color : #ff0000\" onclick=\"window.open('https://www.BostonApartments.com/clpost.php?ad=$cid&cli=$grid&uid=$uid', 'asdas', 'toolbars=0,width=950,height=900,left=200,top=25,scrollbars=1,resizable=1');\" value=\"CLICK HERE to Post To Craigslist\">";
?> (in a new window) <I>if you use pop-up blockers, turn them off or allow pop-ups from BostonApartments.com</I>)</NOBR>
...
echo "<iframe seamless height=330 width=100% scrolling=no src=".$file3."></iframe>"; 
?>
