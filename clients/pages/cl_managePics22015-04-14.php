...
echo "<button onclick=\"window.open('https://www.BostonApartments.com/clpost.php?ad=$cid&cli=$grid&uid=$uid', 'asdas', 'toolbars=0,left=20,top=20,height=1200,width=1000,scrollbars=1,resizable=1');\" class=\"button-green pure-button\">CLICK HERE to Post To Craigslist</button>";
