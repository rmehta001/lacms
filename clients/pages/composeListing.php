<!--BEGIN composeListing -->
	...
	<div class="conArea" style="width:560;">	
		...
		<tr>
			...
			<tr>
			<td height="30" align="right" bgcolor="#FFFF99"><div class="controltext">Phone:<input type="input" name="TENANT_PHONE" value="<?php echo $rowGetAd->TENANT_PHONE;?>">
			</tr>
			</table></td>
	...
	<div class="conArea" style="width:560;">
		<table>
		<tr>
			<td height="30"  bgcolor="#FFFF99"><div class="controltext">Notes:</div><textarea name="LISTING_NOTES" rows="4" cols="40"></textarea></td>
		</tr>
		</table>
	</div>
