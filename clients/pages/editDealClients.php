...
<center>
	...
	<form action="<?php echo "$PHP_SELF?op=editDealClientsDo";?>" name="addClientsToDeal" method="POST">
	...
	<td bgcolor="#FFFF99" align="center">
			<table>
			<tr>
			<td align="center" height="30" bgcolor="#FFFF99"><div class="controltext">Edit/link clients to deal.</div></td>
			</tr>
			<tr>
			<td align="center" height="30" bgcolor="#FFFF99">
				...
				<td align="center" height="30" width="160" bgcolor="#FFFF99"><div class="controltext">Clients linked to deal</div></td></tr>
				<tr>
	...
	<td bgcolor="#FFFF99" align="center">
			<table>
			<tr>
			<td align="center" height="30" bgcolor="#FFFF99"><input type="button" value="Save"  STYLE="Background-Color : #adffad ;" onClick="submit_selected_clients();"></tr>
			</tr>
			</table>
	</td>
        <td valign="top" height="30" width="1" bgcolor="#000000"><img border="0" hspace="0" vspace="0" width="1" height="100%" src="../assets/images/blk_spacer.gif"></td>
