...
<FONT SIZE="-2"><NOBR><a href="<?php echo $PHP_SELF;?>?op=changeLLListingsdo&amp;lid=<?php echo $rowGetLandlord->LID;?>&amp;grid=<?php echo $grid;?>&amp;next_contact=<?php echo $rowGetLandlord->NEXT_CONTACT;?>"><button class="button-green pure-button">Set All This Landlord's Listings to Updated Today (NEW)</button></A></NOBR>
...
<TD BGCOLOR=FFFFFF VALIGN="TOP"><FONT SIZE="-2"><A HREF="<?php echo "$PHP_SELF?op=adlEdit&LLID=$lid";?>"><IMG SRC="../images/edit-new-listing-ll.gif" border="0" TITLE="Create a New Listing for this landlord">Create a New Listing for this landlord</A></FONT></TD><TD BGCOLOR=FFFFFF VALIGN="TOP" ALIGN="CENTER"><NOBR> <?php
	echo "<NOBR>$num_Buildings <A HREF=$PHP_SELF?op=buildings&lid=$rowGetLandlord->LID&llname=$rowGetLandlord->SHORT_NAME><IMG src=../assets/images/buildings.jpg BORDER=0 TITLE=\"Edit Landlord's Units By Building Globally/Individually\"></A> | <A HREF=$PHP_SELF?op=global-Landlord&lid=$rowGetLandlord->LID&llname=$rowGetLandlord->SHORT_NAME><IMG src=../assets/images/global.jpeg BORDER=0 TITLE=\"Make Global changes to ALL Listings for $rowGetLandlord->SHORT_NAME\"></A></NOBR>";
; ?></NOBR></TD></TR></TABLE>
...
&nbsp;
	...
	<td>
		...
		<table width="100%">
			<tr>
			<td align="left" valign="top"><div class="controltext" style="font-size:10px;">Addendum Notes:</div><textarea cols="30" rows="9" name="addendum"><?php echo $rowGetLandlord->ADDENDUM;?></textarea><BR>
<A HREF="<?php echo "$PHP_SELF?op=addendums&lid=$lid";?>"  TITLE="Click to Manage Documents for this landlord"><img src="../assets/images/full.gif" width="15" height="15" BORDER="0"  TITLE="Click to Manage Documents for this landlord"><NOBR><B>Additional Addenda &amp; Forms</B></A></NOBR><BR>
</td>
...
<?php
	echo "<NOBR><A HREF=$PHP_SELF?op=global-Landlord&lid=$rowGetLandlord->LID><IMG src=../assets/images/global.jpeg BORDER=0 TITLE=\"Make Global changes to ALL Listings for $rowGetLandlord->SHORT_NAME\"><FONT SIZE=1px>&nbsp;Make Global changes to ALL Listings for $rowGetLandlord->SHORT_NAME</FONT></A></NOBR>";
; ?>
<BR><BR>
...
<CENTER>
<?php
	echo "<A HREF=$PHP_SELF?op=buildings&lid=$rowGetLandlord->LID&llname=$rowGetLandlord->SHORT_NAME><IMG src=../assets/images/buildings.jpg BORDER=0><FONT SIZE=1px><BR>Buildings</FONT></A>";
; ?>
</CENTER>
</TD><TD>&nbsp;</TD><TD>
<div class="controltext"><B><?php echo "Landlord has $num_Buildings buildings</B><BR>";?>
<?php if ($user_level>=3) { ?>
<FONT style="font-size:7px;"><I>Click address for global changes</I></FONT></B>
<?php } ?>
...
<a href="<?php echo "$PHP_SELF?op=pics-building&street_num=$rowBuildings->STREET_NUM&street=$rowBuildings->STREET&lid=$lid";?>" target="_NEW"><img border="0" src="../assets/images/pic-gallery.jpeg" HEIGHT="20" WIDTH="26" TITLE="Building Photo Gallery"></a>
