...
<a href="<?php echo "$PHP_SELF?op=return_page_op";?>"><img hspace="0" vspace="0" border="0" src="../assets/images/return.jpg"></a><BR>
<CENTER>
...
echo "<a href=https://www.BostonApartments.com/homepage.php?cli=$rowGetAd->CLI&ad=$rowGetAd->CID target=_NEW>$thumb</A>";
...
<div class="conArea" style="width:700;">

	<div style="width:700; text-align:left; height:10;"><a href="<?php echo "$PHP_SELF?op=hot_list_add&item_type=1&item_id=$cid&return_page=$op&return_page_rid=$cid";?>"><img border="0" hspace="0" vspace="0" width="96" height="23" src="../assets/images/addToHotList.jpg"></a></div>
...
<TABLE><TR><TD>
<font color="#993300">Type:</font></div>
</TD><TD>
<select name="TYPE"><?php while ($rowTypes=mysqli_fetch_object($quTypes)) {	?>
...
<font color="#993300">Location:</font>
</TD><TD>
<select name='LOC'><?php while ($rowLocs = mysqli_fetch_object($quLocs)) {	?>
...
<div class="controltext">Landlord/Owner:<select name="LANDLORD">
				<option value="--">--</option>
...
<td height="30"  bgcolor="#FFFF99"><div class="controltext">
St#:</DIV>
<input type="text" size="5" name="STREET_NUM" value="<?php echo $rowGetAd->STREET_NUM;?>">
</td>

<td height="30"  bgcolor="#FFFF99"><div class="controltext">
Street:</DIV>
<input type="text" size="35" name="STREET" value="<?php echo $rowGetAd->STREET;?>">
</td>

<td height="30"  bgcolor="#FFFF99"><div class="controltext">
Apt #:</DIV>
<input type="text" size="5" name="APT_NUM" value="<?php echo $rowGetAd->APT_NUM;?>">
</td>

<td height="30"  bgcolor="#FFFF99"><div class="controltext">
Floor:</DIV>
<input type="text" size="5" name="FLOOR" value="<?php echo $rowGetAd->FLOOR;?>">
</td>
...
<table><tr>
<td height="30" bgcolor="#FFFF99" valign="bottom"><div class="controltext">Bedrooms</div><select name="ROOMS">
				<option value="--">--</option>
			...
			<td height="30" colspan="1" width="1" bgcolor="#FFFF99" valign="bottom"><div class="controltext">

Bathrooms:</div><select name="BATH">
				<option value="--">--</option>
			...
			<td bgcolor="#FFFF99" align="center" valign="bottom"><div class="controltext"># of Rooms:</DIV>
<input type="text" size="5" name="TOTAL_NUM_ROOMS" value="<?php echo $rowGetAd->TOTAL_NUM_ROOMS;?>">




			<td height="30" width="20" bgcolor="#FFFF99" valign="bottom"><div class="controltext">
SqFt: <input type="text" size="5" name="SQFT" value="<?php echo $rowGetAd->SQFT;?>"></DIV>

</td>


			<td bgcolor="#FFFF99" align="center" valign="bottom">

<div class="controltext">Pets:</div><select name="PETSA">
			<option value="--">--</option>
...
<table><tr><td height="30" bgcolor="#FFFF99"><div class="controltext"><strong>Parking:</strong></div></td>
<td height="30" bgcolor="#FFFF99"><div class="controltext"># of spaces:</div></td>
		...
		<table BORDER=2>
			...
			<td height="30" width="20" bgcolor="#FFFF99" colspan=5>

<div class="controltext" align=center><B>Available:</B></div>
</TD>
...
<div class="controltext">Month:</div><select name="bbbMonth">
				<option value="--">--</option>                                                      
...
<div class="controltext">Price negotiable:

</TD></TR><TR><TD><div class="controltext">
No <input type="radio" value="0" name="PRICE_NEG" <?php if (!$rowGetAd->PRICE_NEG) { echo "checked"; }?> > 
</DIV>
</TD><TD><div class="controltext">

Yes <input type="radio" value="1" name="PRICE_NEG" <?php if ($rowGetAd->PRICE_NEG) { echo "checked"; }?> >
</DIV>
</TD></TR></TABLE>
...
<TABLE><TR><TD>
<div class="controltext">Co-Broke: </DIV>  </TD><TD>   <div class="controltext">Featured Listing </DIV></TD></TR><TR><TD>


<input type="checkbox" value=1 name="COBROKE" <?php if ($rowGetAd->COBROKE>0) { echo " checked "; } ;?>>
...
<TABLE><tr><td height="30" width="1" bgcolor="#FFFF99"><table>
				<tr>
		...
		<table>
		<tr>
			<td height="30" align="center" bgcolor="#FFFF99"><input type="submit" value="Save" STYLE="Background-Color : #adffad"></td>
		</tr>
		</table>
...
&nbsp;
		...
		<table width="100%">
			...
			<table>
		<tr>
			<td height="30" bgcolor="#FFFF99"><div class="controltext">Building Type:</div><select name="BUILDING_TYPE" STYLE="Background-Color : #FFFFFF">
				<option value="--">--</option>
			...
			<td height="30" bgcolor="#FFFF99"><div class="controltext">Building Style:</div><select name="BUILDING_STYLE" STYLE="Background-Color : #FFFFFF">
				<option value="--">--</option>
			...
			<td height="30" width="1" bgcolor="#FFFF99">&nbsp;</td>
			<td height="30" width="1" bgcolor="#FFFF99">&nbsp;</td>
			<td height="30"  width="100" bgcolor="#FFFF99"><div class="controltext">Laundry</div><select name="LAUNDRY_ROOM" STYLE="Background-Color : #FFFFFF">
				<option value="--">--</option>
...
Lease Expire:<br>
		...
		<tr>
			...
			<td height="30"  bgcolor="#FFFF99"><div class="controltext">
Month:</div><select name="bbbLEMonth">
				<option value="--">--</option>                                                      
