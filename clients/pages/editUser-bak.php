...
<textarea name="bio" rows="15" cols="50"><?php echo $rowGetUser->BIO;?></textarea><br>
</TD></TR></TABLE>
...
<P>
<input type="submit" value=" Save Agent <?php echo $rowGetUser->HANDLE;?>'s Settings " STYLE="Background-Color : #E0FFFF">
</form>
<P>
