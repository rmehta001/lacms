...
<BR>
	...
	This form will change the Features &amp; Amenities Furnished setting in Ads in ALL the listings for this landlord in ALL Buildings<BR><BR>
<P>

	<form action="<?php echo "$PHP_SELF?op=global-Landlord-f-furnishedDo";?>" method="POST">
...
<input type="submit" value="Change the Furnished setting in ALL listings in ALL buildings" STYLE="Background-Color : #A9F5A9"></form>
<br>
<P>
<P>&nbsp;<BR>
