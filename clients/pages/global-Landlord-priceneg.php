...
<?php
  ...
  ?>
	...
	This form will change whether the price is negotiable in ALL the listings for this landlord in ALL Buildings<BR><BR>
<P>

	<form action="<?php echo "$PHP_SELF?op=global-Landlord-pricenegDo";?>" method="POST">
...
<input type="submit" value="Change Price is negotiable setting in ALL listings in ALL buildings" STYLE="Background-Color : #A9F5A9"></form>
<br>
<P>
<P>&nbsp;<BR>
