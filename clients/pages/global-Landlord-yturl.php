...
<P>
	<form action="<?php echo "$PHP_SELF?op=global-Landlord-yturlDo";?>" method="POST">
...
<input type="submit" value="Change the YouTube URL in ALL listings in ALL buildings" STYLE="Background-Color : #A9F5A9"></form>
<br>
<P>
<P>&nbsp;<BR>
