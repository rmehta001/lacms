...
<td style="font-size:15px;margin:5px;padding:10px;" VALIGN="TOP">
    <?php 
        ...
        $llname = isset($_GET['llname'])? $_GET['llname']:""; 
    ?>
<IMG src="../assets/images/global.jpeg" BORDER="0" TITLE="Make Global changes to ALL Listings in ALL Buildings for this Landlord">&nbsp;This page is to make changes to ALL Listings for All Buildings for Landlord #<?php if ((isset($lid)) && (isset($llname))) echo "$lid $llname"; ?>.</TD></tr><tr><td>
