<!--BEGIN global alarm code -->

	<center>
<BR>

	<font color="#000000" face="Verdana">
	This form will change the ALARM CODE in ALL<BR>
the listings at <?php echo "$street_num";?> <?php echo "$street";?><BR><BR>
<P>

<form action="<?php echo "$PHP_SELF?op=global-ListingsEdit-alarmcodeDo";?>" method="POST">
...
Enter the NEW Alarm Code and click the button below.<BR>
<P>

		<input type="text" name="ALARM" size="15">

<BR><P>
This change will change EVERY LISTING at <?php echo "$street_num";?> <?php echo "$street";?> for this landlord and cannot be reversed.<BR>
<P>

<input type="submit" value="Change the ALARM CODE in ALL the listings at this building" STYLE="Background-Color : #A9F5A9"></form>
<br>
<P>
<P>&nbsp;<BR>
