...
<BR>
	...
	This form will change the BODY OF THE AD in ALL<BR>
the listings at <?php echo "$street_num";?> <?php echo "$street";?><BR><BR>
<P>

	<form action="<?php echo "$PHP_SELF?op=global-ListingsEdit-bodyDo";?>" method="POST">
...
Enter the Ad Body Text and click the button below.<BR>
<P>
...
<input type="submit" value="Change the AD BODY TEXT in ALL the listings at this building" STYLE="Background-Color : #A9F5A9"></form>
<br>
<P>
<P>&nbsp;<BR>
