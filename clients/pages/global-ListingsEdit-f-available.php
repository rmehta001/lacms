...
<form action="<?php echo "$PHP_SELF?op=global-ListingsEdit-f-availableDo";?>" method="POST">
...
Click the button below to mark all units Available.<BR>
<P>
<BR><P>
This change will change EVERY LISTING at <?php echo "$street_num";?> <?php echo "$street";?> for this landlord and cannot be reversed.<BR>
<P>

<input type="submit" value="Change to AVAILABLE ALL the listings at this building" STYLE="Background-Color : #A9F5A9"></form>
<br>
<P>
<P>&nbsp;<BR>
