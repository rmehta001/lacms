...
<BR>
	...
	This form will change the Features &amp; Amenities Central A/C setting in Ads in ALL the listings at <?php echo "$street_num";?> <?php echo "$street";?><BR><BR>
<P>

	<form action="<?php echo "$PHP_SELF?op=global-ListingsEdit-f-cacDo";?>" method="POST">
...
<input type="submit" value="Change the Central A/C setting in ALL the listings at this building" STYLE="Background-Color : #A9F5A9"></form>
<br>
<P>
<P>&nbsp;<BR>
