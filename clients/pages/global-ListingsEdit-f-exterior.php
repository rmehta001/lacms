...
<BR>
	...
	This form will change the Features &amp; Amenities Exterior setting in Ads in ALL the listings at <?php echo "$street_num";?> <?php echo "$street";?><BR><BR>
<P>

<form action="<?php echo "$PHP_SELF?op=global-ListingsEdit-f-exteriorDo";?>" method="POST">
...
Pick the NEW Exterior setting and click the button below.<BR>
<P>

<span style="font-size:10px;">
Exterior Setting:<br></span>

	<select name="EXTERIOR" STYLE="Background-Color : #FFFFFF">
	<option value="--">--</option>
	<?php foreach ($DEFINED_VALUE_SETS['EXTERIOR'] as $exkey => $exVal) {?>
	<option value="<?php echo $exkey; ?>"><?php echo $exVal;?></option>
	<?php } ?>
	</select>
...
<input type="submit" value="Change the Exterior setting in ALL the listings at this building" STYLE="Background-Color : #A9F5A9"></form>
<br>
<P>
<P>&nbsp;<BR>
