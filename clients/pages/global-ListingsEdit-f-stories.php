...
<BR>
	...
	This form will change the # of Stories setting in Ads in ALL the listings at <?php echo "$street_num";?> <?php echo "$street";?><BR><BR>
<P>

<form action="<?php echo "$PHP_SELF?op=global-ListingsEdit-f-storiesDo";?>" method="POST">
...
Pick the NEW Stories setting and click the button below.<BR>
<P>
...
Stories Setting:<br></span>
	...
	<option value="<?php echo $stkey; ?>"><?php echo $stVal;?></option>
	<?php } ?>
	</select>
...
<input type="submit" value="Change the Stories setting in ALL the listings at this building" STYLE="Background-Color : #A9F5A9"></form>
<br>
<P>
<P>&nbsp;<BR>
