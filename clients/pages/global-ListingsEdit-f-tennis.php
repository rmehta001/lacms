...
<BR>
	...
	This form will change the Features &amp; Amenities Tennis setting in Ads in ALL the listings at <?php echo "$street_num";?> <?php echo "$street";?><BR><BR>
<P>

<form action="<?php echo "$PHP_SELF?op=global-ListingsEdit-f-tennisDo";?>" method="POST">
...
<input type="submit" value="Change the Tennis setting in ALL the listings at this building" STYLE="Background-Color : #A9F5A9"></form>
<br>
<P>
<P>&nbsp;<BR>
