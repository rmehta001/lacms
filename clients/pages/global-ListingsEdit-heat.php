...
<P>
	...
	<form action="<?php echo "$PHP_SELF?op=global-ListingsEdit-heatDo";?>" method="POST">
...
<input type="submit" value="Change the Heating Responsibility in ALL the listings at this building" STYLE="Background-Color : #A9F5A9"></form>
<br>
<P>
<P>&nbsp;<BR>
