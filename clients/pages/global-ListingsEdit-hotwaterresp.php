...
<P>
	...
	<form action="<?php echo "$PHP_SELF?op=global-ListingsEdit-hotwaterrespDo";?>" method="POST">
...
<input type="submit" value="Change the Hot Water Responsibility in ALL the listings at this building" STYLE="Background-Color : #A9F5A9"></form>
<br>
<P>
<P>&nbsp;<BR>
