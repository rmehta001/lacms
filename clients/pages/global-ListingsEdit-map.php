...
<P>
	...
	<form action="<?php echo "$PHP_SELF?op=global-ListingsEdit-mapDo";?>" method="POST">
...
<input type="submit" value="Change the Map Type in Ad in ALL the listings at this building" STYLE="Background-Color : #A9F5A9"></form>
<br>
<P>
<P>&nbsp;<BR>
