...
This form will change the COST PER PARKING SPACE in ALL<BR>
the listings at <?php echo "$street_num";?> <?php echo "$street";?><BR><BR>
<P>

<form action="<?php echo "$PHP_SELF?op=global-ListingsEdit-parkingcostDo";?>" method="POST">
...
Enter the NEW Cost Per Space and click the button below.<BR>
<P>

		$ <input type="text" name="parking_cost" size="5">

<BR><P>
This change will change EVERY LISTING at <?php echo "$street_num";?> <?php echo "$street";?> for this landlord and cannot be reversed.<BR>
<P>

<input type="submit" value="Change the PRICE of the PARKING COST PER SPACE in ALL the listings at this building" STYLE="Background-Color : #A9F5A9"></form>
<br>
<P>
<P>&nbsp;<BR>
