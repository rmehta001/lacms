...
<BR>
	...
	This form will change the SHOWING INSTRUCTIONS in ALL<BR>
the listings at <?php echo "$street_num";?> <?php echo "$street";?><BR><BR>
<P>

	<form action="<?php echo "$PHP_SELF?op=global-ListingsEdit-showinginstructionsDo";?>" method="POST">
...
Enter the Showing Instructions and click the button below.<BR>
<P>

<textarea name="SHOW_INSTRUCT" rows="5" cols="30"></textarea>
...
<input type="submit" value="Change the SHOWING INSTRUCTIONS in ALL the listings at this building" STYLE="Background-Color : #A9F5A9"></form>
<br>
<P>
<P>&nbsp;<BR>
