...
<P>
	...
	<form action="<?php echo "$PHP_SELF?op=global-ListingsEdit-streetnameDo";?>" method="POST">
...
<input type="submit" value="Change the STREET NAME in ALL the listings at this building" STYLE="Background-Color : #A9F5A9"></form>
<br>
<P>
<P>&nbsp;<BR>
