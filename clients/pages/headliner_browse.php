...
$where = "where headliners.GROUP=$grid";
...
<p>
<img src="../images/arrow.gif"><a href="<?php echo "$PHP_SELF?op=headliner_edit";?>" class="menu">Create a new Headliner</a>
</p>
<p>
<?php
...
<hr size="1" noshade></p>
  ...
  ?>
  <tr>
  <td valign="top"><a href="<?php echo "$PHP_SELF?op=headliner_edit";?>&hid=<?php echo $rowGetHeadliners->headliner_id;?>" target="_new" class="menu"><img src="../headliner_images/<?php echo $tn_portrait_path;?>" border="0" width="<?php echo $HEADLINER_TN_PORTRAIT_WIDTH;?>" height="<?php echo $HEADLINER_TN_PORTRAIT_HEIGHT;?>" ></a></td>
  <td width="162" valign="middle"><span class="caption"><?php echo $caption;?></span></td>
  <td valign="middle"><span class="menu">
  
  
  <a href="<?php echo "$PHP_SELF?op=headliner_edit";?>&hid=<?php echo $rowGetHeadliners->headliner_id;?>">edit</a></span></td>
