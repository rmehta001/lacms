...
$quLimitCount = mysqli_query($dbh, $quStrLimitCount) or die (dieNice("Sorry,  couldn't pagenate your listings", "E-200"));
...
if ($_POST['filterChange']) {	
	...
	$preFilters_str[98] = array($_POST['amenities_superintendant'], "CLASS.AMENITIES_SUPERINTENDANT","=", "Amenities: Superintendant");
...
?>
	...
	<td bgcolor="#FFFF99" align="center">
		<table>
			...
			<td height="30" width="1" bgcolor="#FFFF99">&nbsp;</td>
			<td height="30" width="20" bgcolor="#FFFF99"><div class="controltext">Not Available:<input type="checkbox" name="status_not_active[]" value="1" <?php if ($switch_remember['status_not_active']) {echo " checked "; }?> ></td>
			</tr>
		</table></td>
	<td valign="top" height="30" width="1"><img border="0" hspace="0" vspace="0" width="1" height="100%" src="../assets/images/blk_spacer.gif"></td>
	</tr>
...
<?php } elseif ($listing_filter_display == "big") {?>
	...
	<td bgcolor="#FFFF99">
			...
			<tr>
			<td height="30" width="110" bgcolor="#FFFF99"><div class="controltext">Landlord(s):<select name="landlord[]" multiple size="4">
	...
	<td align="center" bgcolor="#FFFF99">
		<table>
			<tr>
			<td height="30" width="20" bgcolor="#FFFF99"><div class="controltext">Listing type:<select name="listing_type[]"  multiple size="4">
			...
			<td height="30" width="1" bgcolor="#FFFF99">&nbsp;</td>
			<td height="30" width="20" bgcolor="#FFFF99"><div class="controltext">Lease type:<select name="lease_type[]"  multiple size="4">
			...
			<td height="30" width="1" bgcolor="#FFFF99">&nbsp;</td>
			<td height="30" width="20" valign="bottom" bgcolor="#FFFF99"><div class="controltext">Terms (months):<input type="text" size="3" name="terms[]" value="<?php echo $switch_remember['terms'];?>"></td>
			<td height="30" width="1" bgcolor="#FFFF99">&nbsp;</td>
...
<TD VALIGN="TOP">Number of spaces:</TD>
<TD>
...
<select name="pets[]" multiple size="4">
	...
	<td bgcolor="#FFFF99">
		<table>
			...
			<td valign="top">
				...
				<tr><td align="right" class="controltext">Superintendant </td><td align="left"><input type="checkbox" name="amenities_superintendant[]" value="1" <?php if ($switch_remember['amenities_superintendant']) { echo "checked"; } ?> ></td></tr>
	...
	<td align="center" bgcolor="#FFFF99">
		...
		<td height="30" width="1" bgcolor="#FFFF99">&nbsp;</td>
			...
			<td height="30" width="1" bgcolor="#FFFF99">&nbsp;</td>
			<td height="30" width="20" bgcolor="#FFFF99"><div class="controltext">Rented By: <select name="rented_by[]"  multiple size="4">
			...
			<td colspan="10" height="30" width="100%" bgcolor="#FFFF99" align="center"><input type="submit" value="Filter"></form><form action="<?php echo "$PHP_SELF?op=listings&listing_filter_display=none";?>" method="POST"><input type="hidden" name="clear_filter" value="1"><input type="hidden" name="filter_change" value="1"><input type="submit" value="Clear All"></form></td>
			</tr>
	...
	<td bgcolor="#FFFF99">
			...
			<tr>
			<td height="30" width="100%" bgcolor="#FFFF99" valign="bottom" align="right"><div class="controltext"><a href="<?php echo "$PHP_SELF?op=listings&listing_filter_display=big";?>"><IMG SRC="../images/search.gif" border="0">Search Listings</a></td>
			</tr>
