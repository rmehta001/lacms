...
if ($_POST['filterChange']) {
	...
	$preFilters_str[117] =  array($_POST['Deactivated'], "CLASS.STATUS", "!=", "Deactivated");
	$switch_remember['Deactivated'] = $_POST['Deactivated'][0];
   ...
   <td height="30" width="20" bgcolor="<?php echo $pagebgcolor;?>"><div class="controltext">Pets:</div><select name="pets[]" multiple size="3" STYLE="Background-Color : #FFFFFF; font-size : 8pt;">
	...
	<td bgcolor="<?php echo $pagebgcolor;?>" align="center">
		<table BORDER=0>
			...
			<td height="30" width="20" bgcolor="<?php echo $pagebgcolor;?>" align=right><div class="controltext" align=right><NOBR>Available:&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="status_active[]" value="1" <?php if ($switch_remember['status_active']) {echo " checked "; }?> ></NOBR><BR>
<NOBR>Not Available:<input type="checkbox" name="status_not_active[]" value="1" <?php if ($switch_remember['status_not_active']) {echo " checked "; }?> ></NOBR><BR><NOBR>Subway: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="checkbox" name="amenities_subway[]" value="1" <?php if ($switch_remember['amenities_subway']) { echo "checked"; } ?> ></NOBR><BR>
...
<CENTER><span style="font-size:7px;">Sort by: 
...
<?php if ($user_level>0) {?>
			...
			?>
				...
				<CENTER><a href="<?php echo "$PHP_SELF?op=mail_listing&cid=". $rowGetListings['CID'] . "&return_page=listings&return_page_div=" . $k; ?>">
...
# Baths: </FONT></TD><TD>&nbsp;</TD><TD ALIGN="LEFT"><FONT SIZE="-1"><?php echo $rowGetListings[BATHS];?></FONT></TD></TR><TR><TD><FONT SIZE="-1">
...
LL: <A HREF="<?php echo $PHP_SELF;?>?op=editLandlord&lid=<?php echo $rowGetListings['LANDLORD'];?>" target="_ll"><?php echo $rowGetListings['SHORT_NAME'];?></A><BR>
...
<FONT SIZE="-3">&nbsp;<BR></FONT>
<a href="<?php echo "https://www.BostonApartments.com/digpost.php?ad=".$rowGetListings['CID']."&cli=".$rowGetListings['CLI']."&uid=$uid"."\" target=\"_NEW\"";?>"><img width="16" height="16" border="0" vspace="0" hspace="0" src="../images/icons/dig.gif"></A><BR></CENTER>
...
<a href="/lacms/clients/AgencyArea2.php?op=mail_listing&cid=<?php echo $rowGetListings['CID'];?>&return_page=listings&return_page_div=<?php echo $k;?>"><img border=0 src="../images/icons/email.gif" alt="email"></a><BR>
</CENTER>
