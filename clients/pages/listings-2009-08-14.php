...
<input type="submit" value="Clear Search" STYLE="Background-Color : #F5A9A9;"></form>
</TD></TR></TABLE>
</CENTER>
...
<div class="controltext"><NOBR>Landlord(s):</NOBR></DIV><select name="landlord[]" multiple size="3" STYLE="Background-Color : #FFFFFF; width: 160px; font-size : 8pt;">
				<?php while ($rowGetLandlord = mysqli_fetch_object($quLandlord)) { ?>
					<option value="<?php echo $rowGetLandlord->LID; ?>" 
					<?php if (is_array($switch_remember['landlord'])) { 
						if (in_array($rowGetLandlord->LID, $switch_remember['landlord'])) { 
...
<select name="parking_num[]" multiple size="1" STYLE="Background-Color : #FFFFFF; width : 40px;">
<OPTION VALUE=""> -- </OPTION>
...
<td colspan=3 bgcolor="<?php echo $pagebgcolor;?>" align="center">
	...
	<td bgcolor="<?php echo $pagebgcolor;?>">
		...
		<table CELLPADDING="0" CELLSPACING="0" BORDER="0">
			<tr>
			<td bgcolor="<?php echo $pagebgcolor;?>"><div class="controltext"><NOBR>Street #: <input type="text" size="5" name="street_num" value="<?php echo $switch_remember['street_num']; ?>" STYLE="Background-Color : #FFFFFF; height :20px; font-size : 8pt;"> Street Name: <input type="text" size="25" name="street" value="<?php echo $switch_remember['street']; ?>" STYLE="Background-Color : #FFFFFF; height :20px; font-size : 8pt;"> Zip: <input type="text" size="8" name="zip[]" value="<?php echo $switch_remember['zip'];?>" STYLE="Background-Color : #FFFFFF; height :20px; font-size : 8pt;">
			</td>
			<TD>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
</TD>
...
<input type="submit" value=" Search Listings " STYLE="Background-Color : #A9F5A9;">
</TD></form><TD>&nbsp;&nbsp;</TD><TD VALIGN="TOP">
<form action="<?php echo "$PHP_SELF?op=listings&listing_filter_display=small&availFilter=n";?>" method="POST"><input type="hidden" name="clear_filter" value="1"><input type="hidden" name="filter_change" value="1"><input type="submit" value="Clear Search" STYLE="Background-Color : #F5A9A9;">
</TD></TR></TABLE>
...
<div class="controltext"><NOBR>&nbsp;Not Advertised:<input type="checkbox" name="status[]" <?php if ($switch_remember['status']=='STO') { echo checked;} ?> value="STO">
</NOBR></DIV>
</TD><TD>
...
<form action="<?php echo "$PHP_SELF?op=listings&listing_filter_display=big&availFilter=n";?>" method="POST"><input type="hidden" name="clear_filter" value="1"><input type="hidden" name="filter_change" value="1"><input type="submit" value="Clear Search" STYLE="Background-Color : #F5A9A9;"></form>
</TD></TR></TABLE>
...
<form action="<?php echo "$PHP_SELF?op=listings&listing_filter_display=none&availFilter=n";?>" method="POST"><input type="hidden" name="clear_filter" value="1"><input type="hidden" name="filter_change" value="1"><input type="submit" value="Clear Search" STYLE="Background-Color : #F5A9A9;"></form>
...
<CENTER><span style="font-size:11px;">Sort by: 
...
<?php
                                ...
                                if($rowGetListings[$col[1]])
                                { ?>
                                        <CENTER><a href="<?php echo "$PHP_SELF?op=managePics&cid=" . $rowGetListings['CID'] . "&return_page=listings&return_page_div=$k"; ?>"><img src="../images/pic.gif" alt="view and edit photos" border=0></a></CENTER>
                                <? }else { ?>
...
<img src="../assets/images/mail_listing.gif" border=0></a></CENTER>


                        <?php }elseif ($col[0]=='ssheet') { ?>

<CENTER><a href="javascript:popUpPrintOut('./printout_agent.php?cid=<?php echo $rowGetListings[CID];?>');"><img src="../assets/images/full.gif" vspace="0" hspace="0" border="0" height="18" width="18"></a></CENTER>


                        <?php }elseif ($col[0]=='adprint') { ?>

<CENTER><a href="<?php echo "https://www.BostonApartments.com/homepage.php?ad=".$rowGetListings['CID']."&cli=".$rowGetListings['CLI']."\" target=\"_NEW\"";?>"><img src="../assets/images/printer.gif" vspace="0" hspace="0" border="0" height="18" width="18"></A></CENTER>
...
<img src="../assets/images/inact.jpg" border=0 HEIGHT="16" WIDTH="16">
<?php if ($user_level>0) {?>
</a>
<?php } ?>
...
<?php } ?>
<img src="../assets/images/act.gif" border=0 HEIGHT="16" WIDTH="16">
<?php if ($user_level>0) {?>
</a>
<?php } ?>
			<?php	}else{ echo "ERROR"; }?>
...
<?php }?>
<img src="../assets/images/icons/a.jpg" border=0 HEIGHT="16" WIDTH="16">
<?php if ($user_level>0) {?>
</a>
<?php }?>
</CENTER>
...
<?php } ?>
<img src="../assets/images/icons/u.jpg" border=0 HEIGHT="16" WIDTH="16">
<?php if ($user_level>0) {?>
</a>
<?php } ?><?php } ?></FONT>
</TD></TR></TABLE>
...
<?php	if ($rowGetListings['PIC']!=0)

  {
      ...
      $rowGetPics = mysqli_fetch_object($quGetPics);
         $thumb="<IMG SRC=https://www.BostonApartments.com/pics/$rowGetPics->PID.$rowGetPics->EXT HEIGHT=80 WIDTH=80 BORDER=0>"; 
 	}
else
	{	$thumb="<CENTER><NOBR><FONT SIZE=-1 color=#BDBDBD>No &nbsp; Photo</FONT></NOBR></CENTER>";	}  
...
echo "<a href=https://www.BostonApartments.com/homepage.php?cli=".$rowGetListings['CLI']."&ad=".$rowGetListings['CID']." target=_NEW>$thumb</A>";
 ...
 ?>
	   ...
	   <BR><a href="<?php echo "$PHP_SELF?op=managePics&cid=" . $rowGetListings['CID'] . "&return_page=listings&return_page_div=$k"; ?>"><img src="../images/pic.gif" alt="view and edit photos" border=0></a><BR>
...
# Beds: </FONT></TD><TD>&nbsp;</TD><TD ALIGN="LEFT"><FONT SIZE="-1"> <?php if ($rowGetListings['ROOMS'] == '0.25') {
echo "LOFT";
}
...
# Baths: </FONT></TD><TD>&nbsp;</TD><TD ALIGN="LEFT"><FONT SIZE="-1"><?php echo $rowGetListings['BATH'];?></FONT></TD></TR><TR><TD><FONT SIZE="-1">
...
<?php if ($rowGetListings[OFF_PHONE]!="") {
echo $rowGetListings[OFF_PHONE];
} elseif ($rowGetListings[MOBILE_PHONE]!="") {
echo $rowGetListings[MOBILE_PHONE];
} elseif ($rowGetListings[HOME_PHONE]!="") {
echo $rowGetListings[HOME_PHONE];
} elseif ($rowGetListings[SUPER_PHONE]!="") {
echo $rowGetListings[SUPER_PHONE];
} else {
echo "<font color=#AOAOAO>no phone</FONT>"; } ?> | 

<?php if ($rowGetListings[OFF_EMAIL]!="") {?>
...
<a href="<?php echo "$PHP_SELF?op=mail_landlord&lid=". $rowGetListings['LID'] . "&e=1"; ?>" target="_email">email</A><?php } else { echo "<font color=#AOAOAO>no email</FONT>";} ?><BR>
...
<IMG SRC="https://www.BostonApartments.com/spacer.gif" HEIGHT="1" WIDTH="225" BORDER="0">
</FONT></TD><TD>
&nbsp;
...
<?php if ($rowGetListings['HEATING_RESP']=="2") { echo "Landlord"; } ?>
...
Avail:</FONT></TD><TD ALIGN=RIGHT><FONT SIZE="-1"> <B><?php  echo fuzDate ($rowGetListings['AVAIL']); ?></B></FONT></TD></TR><TR><TD ALIGN=LEFT><FONT SIZE="-1">
Modified: &nbsp;</FONT></TD><TD ALIGN=RIGHT><FONT SIZE="-1"> <?php echo $rowGetListings['MOD']; ?> </FONT></TD></TR>


<TR><TD ALIGN=LEFT><FONT SIZE="-1">
Mod by: &nbsp;</FONT></TD><TD ALIGN=RIGHT><FONT SIZE="-1"> <?php echo $rowGetListings['MODBY']; ?> </FONT></TD></TR>
<TR><TD ALIGN=LEFT><FONT SIZE="-1">
Created: &nbsp;</FONT></TD><TD ALIGN=RIGHT><FONT SIZE="-1"> <?php echo $rowGetListings['HANDLE']; ?> </FONT></TD></TR>
<TR><TD ALIGN=LEFT><FONT SIZE="-1">
ID#: &nbsp;</FONT></TD><TD ALIGN=RIGHT><FONT SIZE="-1"> <a href="/lacms/clients/AgencyArea2.php?op=adlEdit&cid=<?php echo $rowGetListings['CID'];?>&return_page=listings&return_page_div=<?php echo $k;?>"><?php echo $rowGetListings['CID']; ?></A> </FONT></TD></TR>
...
<CENTER><a href="<?php echo "https://www.BostonApartments.com/clpost.php?ad=".$rowGetListings['CID']."&cli=".$rowGetListings['CLI']."&uid=$uid"."\" target=\"_NEW\"";?>"><img width="16" height="16" border="0" vspace="0" hspace="0" src="../images/icons/cl.gif"></A><BR>
<FONT SIZE="-3">&nbsp;<BR></FONT>
<a href="<?php echo "https://www.BostonApartments.com/kijijipost.php?ad=".$rowGetListings['CID']."&cli=".$rowGetListings['CLI']."&uid=$uid"."\" target=\"_NEW\"";?>"><img width="16" height="16" border="0" vspace="0" hspace="0" src="../images/icons/kijiji.gif"></A><BR>
<FONT SIZE="-3">&nbsp;<BR></FONT>
<a href="<?php echo "https://www.BostonApartments.com/digpost.php?ad=".$rowGetListings['CID']."&cli=".$rowGetListings['CLI']."&uid=$uid"."\" target=\"_NEW\"";?>"><img width="16" height="16" border="0" vspace="0" hspace="0" src="../images/icons/dig.gif"></A><BR>
<FONT SIZE="-3">&nbsp;<BR></FONT>

<a href="<?php echo "http://www.facebook.com/share.php?u=http%3A%2F%2Fbostonapartments.com%2Fhomepage.php%3Fcli%3D".$rowGetListings['CLI']."%26ad%3D".$rowGetListings['CID'];?>"><img width="16" height="16" border="0" vspace="0" hspace="0" src="../images/icons/facebook.gif"></A><BR>

<FONT SIZE="-3">&nbsp;<BR></FONT>

<a href="<?php echo "http://twitter.com/home?status=http%3A%2F%2Fbostonapartments.com%2Fhomepage.php%3Fcli%3D".$rowGetListings['CLI']."%26ad%3D".$rowGetListings['CID']."%20title%3DListing%23".$rowGetListings['CID']."%20%24".$rowGetListings['PRICE']."%20".$rowGetListings['LOCNAME']."%20".$rowGetListings['ROOMS']."%20Bed";?>" target="_tweet"><img width="16" height="16" border="0" vspace="0" hspace="0" src="../assets/images/twitter.jpeg"></a>
...
<CENTER>
<a href="/lacms/clients/AgencyArea2.php?op=adlEdit&cid=<?php echo $rowGetListings['CID'];?>&return_page=listings&return_page_div=<?php echo $k;?>"><img border=0 src="../images/icons/edit.gif" alt="edit"></a><BR>
<FONT SIZE="-3">&nbsp;<BR></FONT>
<a href="/lacms/clients/AgencyArea2.php?op=delete&cid=<?php echo $rowGetListings['CID'];?>&return_page=listings&return_page_div=<?php echo $k;?>"><img border=0 src="../images/icons/delete.gif" alt="delete"></a><BR>
<FONT SIZE="-3">&nbsp;<BR></FONT>
<a href="/lacms/clients/AgencyArea2.php?op=hot_list_add&item_type=1&item_id=5412029&return_page=listings&return_page_rid=<?php echo $rowGetListings['CID'];?>&return_page_div=<?php echo $k;?>"><img width="23" height="15" border="0" vspace="0" hspace="0" src="../assets/images/hot.jpg"></a></CENTER>
</CENTER>
</TD><TD>&nbsp;
</TD><TD VALIGN="TOP">
<CENTER>
<a href="javascript:popUpPrintOut('./printout_agent.php?cid=<?php echo $rowGetListings['CID'];?>');"><img src="../assets/images/full.gif" vspace="0" hspace="0" border="0" height="18" width="18"></a><BR>
<FONT SIZE="-3">&nbsp;<BR></FONT>
...
<?php }?>
<img src="../assets/images/icons/vacant.jpg" border=0 height=16 width=16>
<?php if ($user_level>0) {?>
</a>
<?php }?>
			    <?php  } else { ?>
...
<?php } ?>
<img src="../assets/images/icons/occupied.jpg" border=0 height=16 width=16>
<?php if ($user_level>0) {?>
</a>
<?php } ?>
			<?php } ?>
...
<a href="/lacms/clients/AgencyArea2.php?op=mail_listing&cid=<?php echo $rowGetListings['CID'];?>&return_page=listings&return_page_div=<?php echo $k;?>" target="_email"><img border=0 src="../images/icons/email.gif" alt="email"></a><BR>
</CENTER>
...
<CENTER><a href="<?php echo "$PHP_SELF?op=hot_list_add&item_type=1&item_id=$rowGetListings[CID]&return_page=listings&return_page_rid=$rowGetListings[CID]&return_page_div=$k";?>"><img width="23" height="15" border="0" vspace="0" hspace="0" src="../assets/images/hot.jpg"></a></CENTER>


                        <?php }elseif ($col[0]=='cl') { ?>

<CENTER><a href="<?php echo "https://www.BostonApartments.com/clpost.php?ad=".$rowGetListings['CID']."&cli=".$rowGetListings['CLI']."&uid=$uid"."\" target=\"_NEW\"";?>"><img width="16" height="16" border="0" vspace="0" hspace="0" src="../images/icons/cl.gif"></A></CENTER>

                        <?php }elseif ($col[0]=='kijiji') { ?>
<CENTER><a href="<?php echo "https://www.BostonApartments.com/kijijipost.php?ad=".$rowGetListings['CID']."&cli=".$rowGetListings['CLI']."&uid=$uid"."\" target=\"_NEW\"";?>"><img width="16" height="16" border="0" vspace="0" hspace="0" src="../images/icons/kijiji.gif"></A></CENTER>
...
<CENTER><a href="<?php echo "https://www.BostonApartments.com/digpost.php?ad=".$rowGetListings['CID']."&cli=".$rowGetListings['CLI']."&uid=$uid"."\" target=\"_NEW\"";?>"><img width="16" height="16" border="0" vspace="0" hspace="0" src="../images/icons/dig.gif"></A></CENTER>

                        <?php }elseif ($col[0]=='facebook') { ?>

<a href="<?php echo "http://www.facebook.com/share.php?u=http%3A%2F%2Fbostonapartments.com%2Fhomepage.php%3Fcli%3D".$rowGetListings['CLI']."%26ad%3D".$rowGetListings['CID'];?>" target="_face"><img width="16" height="16" border="0" vspace="0" hspace="0" src="../images/icons/facebook.gif"></A><BR>
...
<?php } ?>
	...
	{	$thumb="<CENTER><FONT SIZE=-2 color=#BDBDBD>No Photo</FONT></CENTER>";	}  



echo "<CENTER><a href=https://www.BostonApartments.com/homepage.php?cli=".$rowGetListings['CLI']."&ad=".$rowGetListings['CID']." target=_NEW>$thumb</A>";
