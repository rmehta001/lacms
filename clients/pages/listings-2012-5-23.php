...
elseif ($rowGetListings['CLI']!='1075' AND $rowGetListings['CLI']!=$grid AND $rowGetListings['CLI']!='392') {
 echo "<FONT COLOR=BLUE><B>BA</B></FONT>"; } 
...
if ($rowGetListings['CLI']!='1075' AND $rowGetListings['CLI']!=$grid AND $rowGetListings['CLI']!='392') {
