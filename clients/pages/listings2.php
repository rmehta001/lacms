...
if ($_POST['filterChange']) {
	...
	$preFilters_str[125] =  array($_POST['keyword'], "CLASS.BODY", " LIKE ", "Keyword to Match");
...
<div class="controltext"><NOBR>/Owner(s):</NOBR></DIV><select name="landlord[]" multiple size="3" STYLE="Background-Color : #FFFFFF">
...
<OPTION VALUE="BA" <?php if ($switch_remember['sourcemls']=="BA" or $sourcepref=="BA") { echo "selected"; } ?>>BA Network Only
<OPTION VALUE="BAA" <?php if ($switch_remember['sourcemls']=="BA" or $sourcepref=="BA") { echo "selected"; } ?>>BA Network + OFFICE
<OPTION VALUE="YGL" <?php if ($switch_remember['sourcemls']=="YGL" or $sourcepref=="YGL") { echo "selected"; } ?>>YGL Only
<OPTION VALUE="YGLA" <?php if ($switch_remember['sourcemls']=="YGLAS" or $sourcepref=="YGLA") { echo "selected"; } ?>>YGL + OFFICE
<OPTION VALUE="YGLC" <?php if ($switch_remember['sourcemls']=="YGL" or $sourcepref=="YGLB") { echo "selected"; } ?>>YGL+MLS+OFFICE
<OPTION VALUE="ALL" <?php if ($switch_remember['sourcemls']=="ALL" or $sourcepref=="ALL") { echo "selected"; } ?>>ALL Sources
</SELECT>
</NOBR>
</div>
...
<NOBR>Lead Safe:&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="features_deleaded[]" value="1" <?php if ($switch_remember['features_deleaded']) { echo "checked"; } ?> ></NOBR><BR>

</DIV></td>



<TD VALIGN="MIDDLE"><div class="controltext">
Parking:
</DIV></TD><TD VALIGN="TOP"><div class="controltext">

 <select name="parking_num[]" STYLE="Background-Color : #FFFFFF; width : 40px;" size="3" multiple>
<OPTION VALUE=""> -- </OPTION>
...
<NOBR><FONT SIZE="-2">Begin #</FONT></NOBR><BR><NOBR>(>=):</NOBR></TD><TD><input type="text"  TITLE="Exact Street # (>=)" size="3" name="street_num_begin" value="<?php echo $switch_remember['street_num_begin']; ?>">
</TD><TD>
&nbsp;
</TD><TD>
<NOBR><FONT SIZE="-2">End #:</FONT></NOBR><BR><NOBR>(<=)</NOBR></TD><TD><input type="text" size="3"  TITLE="Exact Street # (<=)" name="street_num_end" value="<?php echo $switch_remember['street_num_end']; ?>">
</TD></TR></TABLE>
</TD><TD>

			<NOBR>Street #:<input type="text" size="5" name="street_num" value="<?php echo $switch_remember['street_num']; ?>" STYLE="Background-Color : #FFFFFF; height :20px; font-size : 8pt;"> Street Name:<input type="text" size="15" name="street" value="<?php echo $switch_remember['street']; ?>" STYLE="Background-Color : #FFFFFF; height :20px; font-size : 8pt;"> Zip: <input type="text" size="5" name="zip[]" value="<?php echo $switch_remember['zip'];?>" STYLE="Background-Color : #FFFFFF; height :20px; font-size : 8pt;"> Ad Keyword: <input type="text" size="10" name="keyword" value="<?php echo $switch_remember['keyword']; ?>" STYLE="Background-Color : #FFFFFF; height :20px; font-size : 8pt;"> 
...
<OPTION VALUE="YGL" <?php if ($switch_remember['sourcemls']=="YGL" or $sourcepref=="YGL") { echo "selected"; } ?>>YGL Only
<OPTION VALUE="YGLA" <?php if ($switch_remember['sourcemls']=="YGLAS" or $sourcepref=="YGLA") { echo "selected"; } ?>>YGL + OFFICE
<OPTION VALUE="YGLB" <?php if ($switch_remember['sourcemls']=="YGL" or $sourcepref=="YGLB") { echo "selected"; } ?>>YGL+OFFICE
<OPTION VALUE="YGLC" <?php if ($switch_remember['sourcemls']=="YGL" or $sourcepref=="YGLB") { echo "selected"; } ?>>YGL+MLS+OFFICE
<OPTION VALUE="ALL" <?php if ($switch_remember['sourcemls']=="ALL" or $sourcepref=="ALL") { echo "selected"; } ?>>ALL Sources
</SELECT>
</NOBR>
...
<td height="30" width="20" bgcolor="<?php echo $pagebgcolor;?>"><div class="controltext"><NOBR>Has No Pics:<input type="checkbox" name="nopic[]" value="1" <?php if ($switch_remember['nopic']) {echo " checked "; }?> >
</NOBR>
</DIV></TD>
</td>
	...
	<CENTER>
		<table>
			...
			<td valign="top">
				...
				<table border="0">
				<tr><td align="right" class="controltext">Lead Safe</td><td align="left"><input type="checkbox" name="features_deleaded[]" value="1" <?php if ($switch_remember['features_deleaded']) { echo "checked"; } ?> ></td></tr>

				<tr><td align="right" class="controltext">Not Lead Safe</td><td align="left"><input type="checkbox" name="not_deleaded[]" value="1" <?php if ($switch_remember['not_deleaded']) { echo "checked"; } ?> ></td></tr>
				...
				<tr><td align="right" class="controltext">Intercom</td><td align="left"><input type="checkbox" name="features_intercom[]" value="1" <?php if ($switch_remember['features_intercom']) { echo "checked"; } ?> ></td></tr>
			...
			<td valign="top">
				...
				<tr><td align="right" class="controltext">Cable TV</td><td align="left"><input type="checkbox" name="features_cabletv[]" value="1" <?php if ($switch_remember['features_cabletv']) { echo "checked"; } ?> ></td></tr>
				<tr><td align="right" class="controltext">Bay Windows</td><td align="left"><input type="checkbox" name="features_baywindows[]" value="1" <?php if ($switch_remember['features_baywindows']) { echo "checked"; } ?> ></td></tr>
				<tr><td align="right" class="controltext">Ceiling Fan</td><td align="left"><input type="checkbox" name="features_ceilingfan[]" value="1" <?php if ($switch_remember['features_ceilingfan']) { echo "checked"; } ?> ></td></tr>				
			...
			<td valign="top">
				...
				<tr><td align="right" class="controltext">Stainless Steel</td><td align="left"><input type="checkbox" name="features_stainless[]" value="1" <?php if ($switch_remember['features_stainless']) { echo "checked"; } ?> ></td></tr>

				<tr><td align="right" class="controltext">Granite Counter</td><td align="left"><input type="checkbox" name="features_granitec[]" value="1" <?php if ($switch_remember['features_granitec']) { echo "checked"; } ?> ></td></tr>
	...
	<CENTER>
		<table>
			...
			<td valign="top">
				...
				<tr><td align="right" class="controltext">Playground </td><td align="left"><input type="checkbox" name="amenities_playground[]" value="1" <?php if ($switch_remember['amenities_playground']) { echo "checked"; } ?> ></td></tr>
				<tr><td align="right" class="controltext">Basketball </td><td align="left"><input type="checkbox" name="amenities_basketball[]" value="1" <?php if ($switch_remember['amenities_basketball']) { echo "checked"; } ?> ></td></tr>
				<tr><td align="right" class="controltext">BBQ </td><td align="left"><input type="checkbox" name="amenities_bbq[]" value="1" <?php if ($switch_remember['amenities_bbq']) { echo "checked"; } ?> ></td></tr>
...
<tr><td align="right" class="controltext">Business Center</td><td align="left"><input type="checkbox" name="amenities_businesscenter[]" value="1" <?php if ($switch_remember['amenities_businesscenter']) { echo "checked"; } ?> ></td></tr>
				...
				<tr><td align="right" class="controltext">Bike Storage </td><td align="left"><input type="checkbox" name="amenities_bikeroom[]" value="1" <?php if ($switch_remember['amenities_bikeroom']) {echo "checked"; }?> ></td></tr>
...
<tr><td align="right" class="controltext">ZipCar</td><td align="left"><input type="checkbox" name="amenities_zipcar[]" value="1" <?php if ($switch_remember['amenities_zipcar']) {echo "checked"; }?> ></td></tr>
...
<CENTER><a href="<?php echo "https://www.BostonApartments.com/homepage-MLS.php?ad=".$rowGetListings['CID']."&cli=".$rowGetListings['CLI']."\" target=\"_NEW\"";?>"><img src="../assets/images/printer.gif" vspace="0" hspace="0" border="0" height="18" width="18" alt="Print the Ad" title="Print the Ad"></A></CENTER>
...
elseif ($rowGetListings['CSOURCE']=="2") { echo "<FONT COLOR=BLUE><B>YGL</B></FONT>"; }

elseif ($rowGetListings['CLI']!='1075' AND $rowGetListings['CLI']!=$grid AND $rowGetListings['CLI']!='392' AND $rowGetListings['CSOURCE']=="0") {
 echo "<FONT COLOR=BLUE><B>BA</B></FONT>"; } elseif 
 

 ($rowGetListings['CLI']=="1075" AND $rowGetListings['STATUS_ACTIVE']=="1") { echo "<FONT COLOR=BLUE><B>MLS</B></FONT>"; } 
  elseif  
 ($rowGetListings['CLI']=="1075" AND $rowGetListings['STATUS_ACTIVE']=="0") { echo "<FONT COLOR=GRAY><B>MLS</B></FONT>"; } 
...
if ($rowGetListings['CLI']=='1075') {
	$thumb = "<a href=https://www.BostonApartments.com/homepage-MLS.php?cli=".$rowGetListings['CLI']."&ad=".$rowGetListings['CID']." target=_NEW><IMG SRC=https://www.BostonApartments.com/pics/".$rowGetListings['THUMBNAIL']." BORDER=0 HEIGHT=60 WIDTH=60 TITLE=\"Click for Company Display Ad\"></A>";
	} else {
...
echo "<CENTER><a href=https://www.BostonApartments.com/homepage-MLS.php?cli=".$rowGetListings['CLI']."&ad=".$rowGetListings['CID']." target=_NEW BORDER=0  HEIGHT=60 WIDTH=60 TITLE=\"Click for Company Display Ad\">$thumb</A><BR><FONT SIZE=-1>";
...
elseif ($rowGetListings['PETSA']=="8") { echo "<NOBR>Dogs OK</NOBR>"; }
elseif ($rowGetListings['PETSA']=="9") { echo "<NOBR>Dogs Breed Rules</NOBR>"; }
?>
...
<a href="<?php echo "http:///www.bostonapartments.com/plugin/?ad=".$rowGetListings['CID']."&uid=$uid&cli=".$rowGetListings['CLI']."\" target=_cl".$rowGetListings['CID']."><img width=\"16\" height=\"16\" border=\"0\" vspace=\"0\" hspace=\"0\" src=\"../images/icons/cl.gif\" alt=\"Post to Craigslist\" title=\"Post to Craigslist\"></a>";
...
<FONT SIZE="-3">&nbsp;<BR></FONT>
<a href="<?php echo "https://www.BostonApartments.com/kijijipost.php?ad=".$rowGetListings['CID']."&cli=".$rowGetListings['CLI']."&uid=$uid"."\" target=\"_KIJ".$rowGetListings['CID']."\"";?>"><img width="16" height="16" border="0" vspace="0" hspace="0" src="../images/icons/kijiji.gif" alt="Post to Ebay Classifieds" title="Post to Ebay Classifieds"></A><BR>
<FONT SIZE="-3">&nbsp;<BR></FONT>
...
<CENTER><a href="<?php echo "http:///www.bostonapartments.com/plugin/?ad=".$rowGetListings['CID']."&uid=$uid&cli=".$rowGetListings['CLI']."\" target=_cl".$rowGetListings['CID']."><img width=\"16\" height=\"16\" border=\"0\" vspace=\"0\" hspace=\"0\" src=\"../images/icons/cl.gif\" alt=\"Post to Craigslist\" title=\"Post to Craigslist\"></a>"; ?>



                        <?php }elseif ($col[0]=='kijiji') { ?>
<CENTER><a href="<?php echo "https://www.BostonApartments.com/kijijipost.php?ad=".$rowGetListings['CID']."&cli=".$rowGetListings['CLI']."&uid=$uid"."\" target=\"_KIJ".$rowGetListings['CID']."\"";?>"><img width="16" height="16" border="0" vspace="0" hspace="0" src="../images/icons/kijiji.gif" alt="Post to Ebay Classifieds" title="Post to Ebay Classifieds"></A></CENTER>
...
if ($rowGetListings['CLI']=='1075') {
	echo "<CENTER><a href=https://www.BostonApartments.com/homepage-MLS.php?cli=".$rowGetListings['CLI']."&ad=".$rowGetListings['CID']." target=_NEW ALT=\"Click for Display Ad\" TITLE=\"Click for Display Ad\">$thumb</A>";
	} else {
