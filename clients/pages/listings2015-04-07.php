...
<OPTION VALUE="RJ" <?php if ($switch_remember['sourcemls']=="RJ" or $sourcepref=="RJ") { echo "selected"; } ?>>Zillow Only
<OPTION VALUE="RJA" <?php if ($switch_remember['sourcemls']=="RJ" or $sourcepref=="RJA") { echo "selected"; } ?>>Zillow + Office
...
<OPTION VALUE="YGLB" <?php if ($switch_remember['sourcemls']=="YGL" or $sourcepref=="YGLB") { echo "selected"; } ?>>YGL+ZR+OFFICE
<OPTION VALUE="YGLC" <?php if ($switch_remember['sourcemls']=="YGL" or $sourcepref=="YGLB") { echo "selected"; } ?>>YGL+ZR+MLS+OFFICE
...
elseif ($rowGetListings['CLI']!='1075' AND $rowGetListings['CLI']!=$grid AND $rowGetListings['CLI']!='392' AND $rowGetListings['CSOURCE']=="0") {
 echo "<FONT COLOR=BLUE><B>BA</B></FONT>"; } elseif ($rowGetListings['CLI']=="1075") { echo "<FONT COLOR=BLUE><B>MLS</B></FONT>"; } 
...
<?php
if (($rowGetListings['FEATURES_DELEADED']=="1") and ($rowGetListings['TYPE']=="1")){ echo "Lead Safe"; }
?>
...
<a href="<?php echo "$PHP_SELF?op=cl_managePics&cid=".$rowGetListings['CID']."\" target=_cl".$rowGetListings['CID']."><img width=\"16\" height=\"16\" border=\"0\" vspace=\"0\" hspace=\"0\" src=\"../images/icons/cl.gif\" alt=\"Post to Craigslist\" title=\"Post to Craigslist\"></a>";
...
<CENTER><a href="<?php echo "$PHP_SELF?op=cl_managePics&cid=".$rowGetListings['CID']."\" target=_cl".$rowGetListings['CID']."><img width=\"16\" height=\"16\" border=\"0\" vspace=\"0\" hspace=\"0\" src=\"../images/icons/cl.gif\" alt=\"Post to Craigslist\" title=\"Post to Craigslist\"></a></center>"; ?>
