...
if ($_POST['filterChange']) {
	...
	if ($_POST['sourcemls']=="1024") {
		$defaultmls = "2";
		$switch_remember['sourcemls'] = '1024';

		
	} elseif  ($_POST['sourcemls']=="1024A") {
		$defaultmls = "3";
		$switch_remember['sourcemls'] = '1024A';
...
<div class="controltext"><NOBR>&nbsp;<IMG SRC="../images/search.gif" border="0"> <B>Search Listings:</B> <a href="<?php echo "$PHP_SELF?op=listings3&listing_filter_display=big";?>">Full Search</a> | <a href="<?php echo "$PHP_SELF?op=listings3&listing_filter_display=small";?>">Simple Search</a> | <a href="<?php echo "$PHP_SELF?op=listings&listing_filter_display=mobile";?>">Mobile Search</a> | <a href="<?php echo "$PHP_SELF?op=listings&listing_filter_display=none";?>">Hide Search Form</a> | <a id="displayMenu" href="javascript:togglemenu();">Hide Menu</a>&nbsp;</NOBR></DIV>
</TD></TR></TABLE>
<?php }?>
	...
	<form action="<?php echo "$PHP_SELF?op=listings3&listing_filter_display=$listsearchs1";?>" method="POST">
...
<OPTION VALUE="1024" <?php if ($switch_remember['sourcemls']=="1024" or $sourcepref=="1024") { echo "selected"; } ?>>MLS + OFFICE
<OPTION VALUE="1024A" <?php if ($switch_remember['sourcemls']=="1024A" or $sourcepref=="1024A") { echo "selected"; } ?>>MLS Only
<OPTION VALUE="BA" <?php if ($switch_remember['sourcemls']=="BA" or $sourcepref=="BA") { echo "selected"; } ?>>BA Network Only
<OPTION VALUE="RJ" <?php if ($switch_remember['sourcemls']=="RJ" or $sourcepref=="RJ") { echo "selected"; } ?>>RentJuice Only
...
<form action="<?php echo "$PHP_SELF?op=listings3&listing_filter_display=small&availFilter=n";?>" method="POST"><input type="hidden" name="clear_filter" value="1"><input type="hidden" name="filter_change" value="1">
<input type="image" src="../assets/images/button-searchclear.png" alt="Clear Search"></form>
	...
	<td bgcolor="<?php echo $pagebgcolor;?>">
			...
			<tr>
			<td height="30" width="100%" bgcolor="<?php echo $pagebgcolor;?>" valign="bottom" align="right"><div class="controltext"><NOBR><IMG SRC="../images/search.gif" border="0"> <B>Search Listings:</B> <a href="<?php echo "$PHP_SELF?op=listings3&listing_filter_display=big";?>">Full Search</a> | <a href="<?php echo "$PHP_SELF?op=listings3&listing_filter_display=small";?>">Simple Search</a> | <a href="<?php echo "$PHP_SELF?op=listings3&listing_filter_display=mobile";?>">Mobile Search</a> | <a href="<?php echo "$PHP_SELF?op=listings3&listing_filter_display=none";?>">Hide Search Form</a> | <a id="displayMenu" href="javascript:togglemenu();">Hide/Show Menu</a></NOBR></DIV></td>
			</tr>
...
<OPTION VALUE="1024A" <?php if ($switch_remember['sourcemls']=="1024A" or $sourcepref=="1024A") { echo "selected"; } ?>>MLS Only
<OPTION VALUE="BA" <?php if ($switch_remember['sourcemls']=="BA" or $sourcepref=="BA") { echo "selected"; } ?>>BA Network Only
<OPTION VALUE="RJ" <?php if ($switch_remember['sourcemls']=="RJ" or $sourcepref=="RJ") { echo "selected"; } ?>>Rent Juice Only
<OPTION VALUE="YGL" <?php if ($switch_remember['sourcemls']=="YGL" or $sourcepref=="YGL") { echo "selected"; } ?>>YGL Only
<OPTION VALUE="ALL" <?php if ($switch_remember['sourcemls']=="ALL" or $sourcepref=="ALL") { echo "selected"; } ?>>ALL Sources
</SELECT>
</NOBR>
...
<form action="<?php echo "$PHP_SELF?op=listings3&listing_filter_display=small&availFilter=n";?>" method="POST"><input type="hidden" name="clear_filter" value="1"><input type="hidden" name="filter_change" value="1"><input type="image" src="../assets/images/button-searchclear.png" alt="Clear Search">
</TD></TR></TABLE>
...
<form action="<?php echo "$PHP_SELF?op=listings3&listing_filter_display=big&availFilter=n";?>" method="POST"><input type="hidden" name="clear_filter" value="1"><input type="hidden" name="filter_change" value="1"><input type="image" src="../assets/images/button-searchclear.png" alt="Clear Search"></form>
</TD></TR></TABLE>
	...
	<td colspan="7" valign="top" width="100%" height="1" bgcolor="#000000"><img border="0" hspace="0" vspace="0" width="100%" height="1" src="../assets/images/blk_spacer.gif"></td>
			...
			<tr>
			<td height="30" width="100%" colspan="10" bgcolor="<?php echo $pagebgcolor;?>" valign="bottom" align="right"><div class="controltext"><NOBR><IMG SRC="../images/search.gif" border="0"> <B>Search Listings:</B> <a href="<?php echo "$PHP_SELF?op=listings3&listing_filter_display=big";?>">Full Search</a> | <a href="<?php echo "$PHP_SELF?op=listings3&listing_filter_display=small";?>">Simple Search</a> | <a href="<?php echo "$PHP_SELF?op=listings3&listing_filter_display=mobile";?>">Mobile Search</a> | <a href="<?php echo "$PHP_SELF?op=listings3&listing_filter_display=none";?>">Hide Search Form</a> | <a id="displayMenu" href="javascript:togglemenu();">Toggle Menu</a></NOBR></DIV></td>
			</tr>
...
<NOBR>
<IMG SRC="../images/search.gif" border="0"> <B>Search Listings:</B> <a href="<?php echo "$PHP_SELF?op=listings3&listing_filter_display=big";?>">Full Search</a> | <a href="<?php echo "$PHP_SELF?op=listings3&listing_filter_display=small";?>">Simple Search</a> | <a href="<?php echo "$PHP_SELF?op=listings3&listing_filter_display=mobile";?>">Mobile Search</a> | <a href="<?php echo "$PHP_SELF?op=listings3&listing_filter_display=none";?>">Hide Search Form</a> | <a id="displayMenu" href="javascript:togglemenu();">Toggle Menu</a> &nbsp;</NOBR>
</DIV>
...
<form action="<?php echo "$PHP_SELF?op=listings3&listing_filter_display=none&availFilter=n";?>" method="POST"><input type="hidden" name="clear_filter" value="1"><input type="hidden" name="filter_change" value="1"><input type="image" src="../assets/images/button-searchclear.png" alt="Clear Search"></form>
...
<?php } ?>
	...
	<table border="0" cellspacing="0" cellpadding="0" height="10" BGCOLOR="lightgrey">
		...
		<div class="controltext">
		 <a href="<?php echo "$PHP_SELF?op=listings3&start=z&limitN=$num_rows&filterChange=1";?>">Show all listings</a> -
		    <?php
		    if ($userFilter) { ?>
		    	<a href="<?php echo "$PHP_SELF?op=listings3&start=z&userFilter=n&filterChange=1";?>">Show all listings for <?php echo $group;?></a>
		    <?php } else { ?>
		    	<a href="<?php echo "$PHP_SELF?op=listings3&start=z&userFilter=1&filterChange=1";?>">Show only <?php echo $handle;?>'s listings</a>
		    <?php } ?>
		   -
		    <?php
		    if ($activeFilter) { ?>
		    	<a href="<?php echo "$PHP_SELF?op=listings3&start=z&activeFilter=n&filterChange=1";?>">Show all active and inactive listings</a>
		    <?php } else { ?>
		    	<a href="<?php echo "$PHP_SELF?op=listings3&start=z&activeFilter=1&filterChange=1";?>">Show only active listings</a>
...
<a href="<?php echo "$PHP_SELF?op=listings3&sort=STATUS_PENDING&sortD=$antiSortD";?>"><font color="<?php echo $rowGetView['COLOR1'];?>"><?php echo "<span style=\"font-size:9px;\">Pndg</FONT>";?><?php echo $sortImage;?></span></a>
...
<a href="<?php echo "$PHP_SELF?op=listings3&sort=PRICE&sortD=$antiSortD";?>"><font color="<?php echo $rowGetView['COLOR1'];?>"><?php echo "PRICE";?><?php echo $sortImage;?></font></a>

&nbsp;

<a href="<?php echo "$PHP_SELF?op=listings3&sort=LOC&sortD=$antiSortD";?>"><font color="<?php echo $rowGetView['COLOR1'];?>"><?php echo "LOCATION";?><?php echo $sortImage;?></font></a>

&nbsp;

<a href="<?php echo "$PHP_SELF?op=listings3&sort=AVAIL&sortD=$antiSortD";?>"><font color="<?php echo $rowGetView['COLOR1'];?>"><?php echo "AVAILABLE";?><?php echo $sortImage;?></font></a>

&nbsp;

<a href="<?php echo "$PHP_SELF?op=listings3&sort=STATUS_ACTIVE&sortD=$antiSortD";?>"><font color="<?php echo $rowGetView['COLOR1'];?>"><?php echo "AVAILABILITY";?><?php echo $sortImage;?></font></a>

&nbsp;

<a href="<?php echo "$PHP_SELF?op=listings3&sort=MOD&sortD=$antiSortD";?>"><font color="<?php echo $rowGetView['COLOR1'];?>"><?php echo "MODIFIED";?><?php echo $sortImage;?></font></a>

&nbsp;

<a href="<?php echo "$PHP_SELF?op=listings3&sort=ROOMS&sortD=$antiSortD";?>"><font color="<?php echo $rowGetView['COLOR1'];?>"><?php echo "BEDS";?><?php echo $sortImage;?></font></a>

&nbsp;

<a href="<?php echo "$PHP_SELF?op=listings3&sort=PIC&sortD=$antiSortD";?>"><font color="<?php echo $rowGetView['COLOR1'];?>"><?php echo "PICS";?><?php echo $sortImage;?></font></a>

&nbsp;

<a href="<?php echo "$PHP_SELF?op=listings3&sort=STATUS&sortD=$antiSortD";?>"><font color="<?php echo $rowGetView['COLOR1'];?>"><?php echo "AD STATUS";?><?php echo $sortImage;?></font></a>

&nbsp;

<a href="<?php echo "$PHP_SELF?op=listings3&sort=LANDLORD&sortD=$antiSortD";?>"><font color="<?php echo $rowGetView['COLOR1'];?>"><?php echo "LANDLORD";?><?php echo $sortImage;?></font></a>

&nbsp;

<a href="<?php echo "$PHP_SELF?op=listings3&sort=UID&sortD=$antiSortD";?>"><font color="<?php echo $rowGetView['COLOR1'];?>"><?php echo "CREATED BY";?><?php echo $sortImage;?></font></a>

&nbsp;

<a href="<?php echo "$PHP_SELF?op=listings3&sort=MODBY&sortD=$antiSortD";?>"><font color="<?php echo $rowGetView['COLOR1'];?>"><?php echo "MOD BY";?><?php echo $sortImage;?></font></a>

&nbsp;

<a href="<?php echo "$PHP_SELF?op=listings3&sort=DATEONMARKET&sortD=$antiSortD";?>"><font color="<?php echo $rowGetView['COLOR1'];?>"><?php echo "DOM";?><?php echo $sortImage;?></font></a>

&nbsp;

<a href="<?php echo "$PHP_SELF?op=listings3&sort=STATUS_PENDING&sortD=$antiSortD";?>"><font color="<?php echo $rowGetView['COLOR1'];?>"><?php echo "PENDING";?><?php echo $sortImage;?></font></a>
...
<a href="<?php echo "$PHP_SELF?op=listings3&sort=$col[1]&sortD=$antiSortD";?>"><font color="<?php echo $rowGetView['COLOR1'];?>"><?php echo $col[3];?><?php echo $sortImage;?></font></a>
...
<?php if ($rowGetListings['CLI']=='1024') { ?>
...
if ($rowGetListings['CSOURCE']=="1") { echo "<FONT COLOR=BLUE><B>RJ</B></FONT>"; }

elseif ($rowGetListings['CSOURCE']=="2") { echo "<FONT COLOR=BLUE><B>YGL</B></FONT>"; }

elseif ($rowGetListings['CLI']!='1024' AND $rowGetListings['CLI']!=$grid AND $rowGetListings['CLI']!='392' AND $rowGetListings['CSOURCE']=="0") {
 echo "<FONT COLOR=BLUE><B>BA</B></FONT>"; } elseif ($rowGetListings['CLI']=="1024") { echo "<FONT COLOR=BLUE><B>MLS</B></FONT>"; } 
...
<?php if ($rowGetListings[CLI]=="1024")  {
if ($rowGetListings[CLI]=="1024" AND $rowGetListings[MLS_AGENCY]!="") { echo "<NOBR><FONT COLOR=RED><B>MLS Listing Agency:</B></FONT> <FONT COLOR=BLUE><B>".$rowGetListings[MLS_AGENCY]."</B></FONT></NOBR><BR>"; }
if ($rowGetListings[CLI]=="1024" AND $rowGetListings[MLS_AGENT]!="") { echo "<NOBR><FONT COLOR=RED></B>MLS Listing Agent:</B></FONT> <FONT COLOR=BLUE><B>".$rowGetListings[MLS_AGENT]."</B></FONT></NOBR><BR>"; }
if ($rowGetListings[CLI]=="1024" AND $rowGetListings[MLS_CONTACT]!="") { echo "<NOBR><FONT COLOR=RED>Listing Email:</B></FONT> <FONT COLOR=BLUE><B><A HREF=mailto:".$rowGetListings[MLS_CONTACT].">".$rowGetListings[MLS_CONTACT]."</A></B></FONT></NOBR><BR>"; }
if (($rowGetListings[CLI]=="1024" AND $rowGetListings[MLS_PHONE]!="") AND ($rowGetListings[MLS_PHONE]!=$rowGetListings[MLS_CONTACT])) { echo "<NOBR><FONT COLOR=RED>Listing Phone:</B></FONT> <FONT COLOR=BLUE><B>".$rowGetListings[MLS_PHONE]."</B></FONT></NOBR><BR>"; }
if (($rowGetListings[CLI]=="1024" AND $rowGetListings[MLS_PHONEOFFICE]!="")) { echo "<NOBR><FONT COLOR=RED>Listing Office Phone:</B></FONT> <FONT COLOR=BLUE><B>".$rowGetListings[MLS_PHONEOFFICE]."</B></FONT></NOBR><BR>"; }
if (($rowGetListings[CLI]=="1024" AND $rowGetListings[EXTERNALID]!="")) { echo "<NOBR><FONT COLOR=RED>MLS ID #:</B></FONT> <FONT COLOR=BLUE><B>".$rowGetListings[EXTERNALID]."</B></FONT></NOBR><BR>"; }
}
...
if (($rowGetListings[EXTERNALID]!="")) { echo "<NOBR><FONT COLOR=RED>RJ ID #:</B></FONT> <FONT COLOR=BLUE><B>".$rowGetListings[EXTERNALID]."</B></FONT></NOBR><BR>"; }
...
if ($rowGetListings['CLI']=="1024") { echo "<FONT COLOR=BLUE><B>MLS</B></FONT>"; } else {
	...
	<table border="0" cellspacing="0" cellpadding="0" height="10" BGCOLOR="lightgrey">
		...
		<div class="controltext">
		 <a href="<?php echo "$PHP_SELF?op=listings3&start=z&limitN=$num_rows&filterChange=1";?>">Show all listings</a> -
		    <?php
		    if ($userFilter) { ?>
		    	<a href="<?php echo "$PHP_SELF?op=listings3&start=z&userFilter=n";?>">Show all listings for <?php echo $group;?></a>
		    <?php } else { ?>
		    	<a href="<?php echo "$PHP_SELF?op=listings3&start=z&userFilter=1";?>">Show only <?php echo $handle;?>'s listings</a>
		    <?php } ?>
		   -
		    <?php
		    if ($activeFilter) { ?>
		    	<a href="<?php echo "$PHP_SELF?op=listings3&start=z&activeFilter=n";?>">Show all active and inactive listings</a>
		    <?php } else { ?>
		    	<a href="<?php echo "$PHP_SELF?op=listings3&start=z&activeFilter=1";?>">Show only active listings</a>
		    <?php } ?>
