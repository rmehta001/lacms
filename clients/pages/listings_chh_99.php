...
<NOBR>Parking: <select name="parking_num[]" STYLE="Background-Color : #FFFFFF; width : 40px;" multiple="multiple" size="1">
<OPTION VALUE=""> -- </OPTION>
...
z			<?php while($rowLocs = mysqli_fetch_object($quLocs)) { ?>
				<option value="<?php echo $rowLocs->LOCID;?>" 
			<?php if (is_array($switch_remember['loc'])) {
				if (in_array($rowLocs->LOCID, $switch_remember['loc'])) { 
					echo " selected ";
...
$quStrGetname = "SELECT * FROM `USERS` WHERE `GROUP`=$grid";
...
echo "<CENTER><a href=https://www.BostonApartments.com/homepage.php?cli=".$rowGetListings['CLI']."&ad=".$rowGetListings['CID']." target=_NEW BORDER=0  HEIGHT=60 WIDTH=60 TITLE=\"Click for Company Display Ad\">$thumb</A><BR><FONT SIZE=-1>";
	   ...
	   <BR><NOBR><a href="<?php echo "$PHP_SELF?op=managePics&cid=" . $rowGetListings['CID'] . "&return_page=listings&return_page_div=$k"; ?>"><img src="../images/pic.gif" alt="View and Edit Photos" title="View and Edit Photos" border=0></a>&nbsp;<?php
		      if ($rowGetListings['STREET_NUM'] !="" AND $rowGetListings['STREET'] !="") {
		       echo "&nbsp;<a href=\"$PHP_SELF?op=pics-building&street_num=" . $rowGetListings['STREET_NUM'] . "&street=" . $rowGetListings['STREET'] . "\" target=\"_NEW\"><img border=\"0\" src=\"../assets/images/pic-gallery.jpeg\" HEIGHT=\"17\" WIDTH=\"24\"  alt=\"Building Picture Gallery\" title=\"Building Picture Gallery\"></a>"; }
?>
</NOBR><BR>
...
<BR>
<FONT SIZE="-3"><BR></FONT>
<a href="<?php echo "$PHP_SELF?op=mark_status_updated&cid=$rowGetListings[CID]&return_page=listings&return_page_rid=$rowGetListings[CID]&return_page_div=$k";?>"><img border="0" vspace="0" hspace="0" src="https://www.BostonApartments.com/images/newIcon.gif" alt="Mark As Updated" title="Mark As Updated"></a><BR>
<FONT SIZE="-3">&nbsp;<BR></FONT>
