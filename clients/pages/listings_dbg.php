...
<div class="controltext"><NOBR><IMG SRC="../images/search.gif" border="0"> <B>Search Listings:</B> <a href="<?php echo "$PHP_SELF?op=listings_dbg&listing_filter_display=big";?>">Full Search</a> | <a href="<?php echo "$PHP_SELF?op=listings_dbg&listing_filter_display=small";?>">Simple Search</a> | <a href="<?php echo "$PHP_SELF?op=listings_dbg&listing_filter_display=mobile";?>">Mobile Search</a> | <a href="<?php echo "$PHP_SELF?op=listings_dbg&listing_filter_display=none";?>">Hide Search Form</a> | <a id="displayMenu" href="javascript:togglemenu();">Hide Menu</a></NOBR></DIV>	
...
<?php }?>
	...
	<form action="<?php echo "$PHP_SELF?op=listings_dbg&listing_filter_display=$listsearchs1";?>" method="POST">
...
<form action="<?php echo "$PHP_SELF?op=listings_dbg&listing_filter_display=small&availFilter=n";?>" method="POST"><input type="hidden" name="clear_filter" value="1"><input type="hidden" name="filter_change" value="1">
<input type="image" src="../assets/images/button-searchclear.png" alt="Clear Search"></form>
	...
	<td bgcolor="<?php echo $pagebgcolor;?>">
			...
			<tr>
			<td height="30" width="100%" bgcolor="<?php echo $pagebgcolor;?>" valign="bottom" align="right"><div class="controltext"><NOBR><IMG SRC="../images/search.gif" border="0"> <B>Search Listings:</B> <a href="<?php echo "$PHP_SELF?op=listings_dbg&listing_filter_display=big";?>">Full Search</a> | <a href="<?php echo "$PHP_SELF?op=listings_dbg&listing_filter_display=small";?>">Simple Search</a> | <a href="<?php echo "$PHP_SELF?op=listings_dbg&listing_filter_display=mobile";?>">Mobile Search</a> | <a href="<?php echo "$PHP_SELF?op=listings_dbg&listing_filter_display=none";?>">Hide Search Form</a> | <a id="displayMenu" href="javascript:togglemenu();">Hide/Show Menu</a></NOBR></DIV></td>
			</tr>
...
<form action="<?php echo "$PHP_SELF?op=listings_dbg&listing_filter_display=big&availFilter=n";?>" method="POST"><input type="hidden" name="clear_filter" value="1"><input type="hidden" name="filter_change" value="1"><input type="image" src="../assets/images/button-searchclear.png" alt="Clear Search"></form>
</TD></TR></TABLE>
	...
	<td colspan="7" valign="top" width="100%" height="1" bgcolor="#000000"><img border="0" hspace="0" vspace="0" width="100%" height="1" src="../assets/images/blk_spacer.gif"></td>
			...
			<tr>
			<td height="30" width="100%" colspan="10" bgcolor="<?php echo $pagebgcolor;?>" valign="bottom" align="right"><div class="controltext"><NOBR><IMG SRC="../images/search.gif" border="0"> <B>Search Listings:</B> <a href="<?php echo "$PHP_SELF?op=listings_dbg&listing_filter_display=big";?>">Full Search</a> | <a href="<?php echo "$PHP_SELF?op=listings_dbg&listing_filter_display=small";?>">Simple Search</a> | <a href="<?php echo "$PHP_SELF?op=listings_dbg&listing_filter_display=mobile";?>">Mobile Search</a> | <a href="<?php echo "$PHP_SELF?op=listings_dbg&listing_filter_display=none";?>">Hide Search Form</a> | <a id="displayMenu" href="javascript:togglemenu();">Toggle Menu</a></NOBR></DIV></td>
			</tr>
...
<NOBR>
<IMG SRC="../images/search.gif" border="0"> <B>Search Listings:</B> <a href="<?php echo "$PHP_SELF?op=listings_dbg&listing_filter_display=big";?>">Full Search</a> | <a href="<?php echo "$PHP_SELF?op=listings_dbg&listing_filter_display=small";?>">Simple Search</a> | <a href="<?php echo "$PHP_SELF?op=listings_dbg&listing_filter_display=mobile";?>">Mobile Search</a> | <a href="<?php echo "$PHP_SELF?op=listings_dbg&listing_filter_display=none";?>">Hide Search Form</a> | <a id="displayMenu" href="javascript:togglemenu();">Toggle Menu</a> &nbsp;</NOBR>
</DIV>
...
<form action="<?php echo "$PHP_SELF?op=listings_dbg&listing_filter_display=none&availFilter=n";?>" method="POST"><input type="hidden" name="clear_filter" value="1"><input type="hidden" name="filter_change" value="1"><input type="image" src="../assets/images/button-searchclear.png" alt="Clear Search"></form>
...
<?php } ?>
	...
	<table border="0" cellspacing="0" cellpadding="0" height="10" BGCOLOR="lightgrey">
		...
		<form action="<?php echo "$PHP_SELF";?>" method="GET" name="listings_view_form"><input type="hidden" name="op" value="listings_dbg">
		...
		<td width="1">&nbsp;</td>
		<td align="center"><form action="<?php echo "$PHP_SELF";?>" method="GET" name="limitNForm"><input type="hidden" name="op" value="listings_dbg"><div class="controltext">Show<input type="text" size="2" name="limitN" value="<?php echo $limitN;?>" onchange="JavaScript:document.limitNForm.submit();">listings per page.</div></form></td>
		<td width="1">&nbsp;</td>
		<td align="center">
		<form action="<?php echo $PHP_SELF;?>" method="GET" name="pageFlipForm">
		<input type="hidden" name="op" value="listings_dbg">
		...
		<div class="controltext">
		 <a href="<?php echo "$PHP_SELF?op=listings_dbg&start=z&limitN=$num_rows&filterChange=1";?>">Show all listings</a> - 
		    <?php 
		    if ($userFilter) { ?>
		    	<a href="<?php echo "$PHP_SELF?op=listings_dbg&start=z&userFilter=n&filterChange=1";?>">Show all listings for <?php echo $group;?></a>
		    <?php } else { ?>
		    	<a href="<?php echo "$PHP_SELF?op=listings_dbg&start=z&userFilter=1&filterChange=1";?>">Show only <?php echo $handle;?>'s listings</a>
		    <?php } ?>
		   -
		    <?php 
		    if ($activeFilter) { ?>
...
<IMG SRC="https://www.BostonApartments.com/spacer.gif" HEIGHT="1" WIDTH="255" BORDER="0">
</FONT></TD><TD>
&nbsp;
