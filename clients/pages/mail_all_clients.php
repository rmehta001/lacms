...
<?php if (isset ($rowGetClients) and ($rowGetClients->CLIENT_EMAIL)) {?>
<?php echo (isset ($rowGetClients) and ($rowGetClients->CLIENT_EMAIL));?>, <?php } ?>
<?php } ?>
" /><br />
...
<?php if(isset($rowGetUser)) echo $rowGetUser->POSITION; {?>
