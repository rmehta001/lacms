...
?>	
	...
	<table border="1" BORDERCOLOR="#000000" cellspacing="0" cellpadding="0" WIDTH="960" BGCOLOR="#FFFFFF"><TR><TD><CENTER>

	<div style="border:1px solid black;width:960px;height:72px;background-color:<?php echo $pagebgcolor;?>;padding:5px;">
...
<NOBR>
Any Partial Name: <input type="text" name="landlords_filter_off_name" value="<?php echo $landlords_filter_off_name;?>" STYLE="Background-Color : #FFFFFF">
...
<TD style="font-size:10px;">
	...
	<a href="<?php echo "$PHP_SELF?op=manageLandlord&landlords_page=$nextPage";?>">Next-></a> 
		...
		<?php if ($landlords_filter_off_name=="" AND $landlords_filter_phone=="" AND $landlords_filter_lc_month=="" AND $landlords_filter_lc_day=="" AND $landlords_filter_lc_year=="" AND $landlords_filter_nc_month=="" AND $landlords_filter_nc_day=="" AND $landlords_filter_nc_year=="" AND $landlords_filter_email=="") { echo " Please search to see Landlords "; } 
		else 
		{
...
<?php
	echo "<A HREF=$PHP_SELF?op=buildings&lid=$rowGetLandlord->LID&llname=$rowGetLandlord->SHORT_NAME>$num_Buildings<IMG src=../assets/images/buildings.jpg BORDER=0 TITLE=\"$rowGetLandlord->SHORT_NAME's Buildings - Edit Units Globally/Individually\"></A>";
 ?>
</CENTER>
</DIV>
</TD>
...
<CENTER>
<?php
	echo "<A HREF=$PHP_SELF?op=global-Landlord&lid=$rowGetLandlord->LID&llname=$rowGetLandlord->SHORT_NAME>$num_Units<IMG src=../assets/images/global.jpeg BORDER=0 TITLE=\"Edit ALL $rowGetLandlord->SHORT_NAME's Units Globally\"></A>";
 ?>
</CENTER>
</DIV>
</TD>
