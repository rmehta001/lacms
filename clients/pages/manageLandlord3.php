...
?>	
	...
	<img border="0" width="35" height="35" src="../assets/images/icons/Address-Book-icon.png">&nbsp;<b>Manage Landlords</b><br>

  <div class="threed" style="padding:.2em;background-color:#fff;">
...
<div class="col-xs-12">
       <div class="col-xs-2">
<section class="cta" style="background-color:#ffffff;padding:4px 0px;padding-bottom:0px"><b><i class="fa fa-search" style="font-size:20px;color:#2297c7;"></i> Find Landlords:</b></section>
</div>
     <div class="col-xs-2">
<section class="cta" style="background-color:#ffffff;padding:0px 0px;padding-bottom:0px">
<p class="small"><input type="text" class="form-control input-sm" id="inputsm" name="landlords_filter_off_name" value="<?php echo $landlords_filter_off_name;?>" placeholder="Any Partial Name"></p></section>

</div>
     <div class="col-xs-2">
<section class="cta" style="background-color:#ffffff;padding:0px 0px;padding-bottom:0px">
<p class="small">
<input type="text" class="form-control input-sm" id="inputsm" value="<?php echo $landlords_filter_phone;?>" STYLE="Background-Color : #FFFFFF" placeholder="Partial Phone Number"></p></section>
</div>
<div class="col-xs-2">

<section class="cta" style="background-color:#ffffff;padding:0px 0px;padding-bottom:0px">
<p class="small">
<input type="text" class="form-control input-sm" id="inputsm" name="landlords_filter_email" value="<?php echo $landlords_filter_email;?>" STYLE="Background-Color : #FFFFFF" placeholder="Email"></p></section>
</div>
...
<section class="cta" style="background-color:#ffffff;padding:0px 0px;padding-bottom:0px">
<p class="small">
<input type="text" class="form-control input-sm" id="inputsm" name="landlords_filter_llnotes" value="<?php echo $landlords_filter_llnotes;?>" STYLE="Background-Color : #FFFFFF" placeholder="Keyword"></p></section>
</div>
     <div class="col-xs-2">
<section class="cta" style="background-color:#ffffff;padding:0px 0px;padding-bottom:0px">
  
<div class="form-group">
<a href="<?php echo "$PHP_SELF?op=manageLandlord&landlords_filter=1";?>"><button type="submit" class="btn btn-info btn-sm"> &nbsp; Search Landlords &nbsp; </button></a>
	</div>
</section></div>
     ...
     <div class="col-xs-12">
	     <div class="col-xs-1">
<section class="cta" style="background-color:#ffffff;padding:0px 0px;padding-bottom:0px">
<b><label for="Last Contacted Date">Last Contacted Date:</label></b></section></div> 
	     <div class="col-xs-1">
<section class="cta" style="background-color:#ffffff;padding:0px 0px;padding-bottom:0px">
<p class="small">
<select class="form-control input-sm" id="inputsm" name="landlords_filter_lc_month" STYLE="Background-Color : #FFFFFF">
...
<section class="cta" style="background-color:#ffffff;padding:0px 0px;padding-bottom:0px">
<p class="small">	
<select name="landlords_filter_lc_day" class="form-control input-sm" id="inputsm">
	<option value="0">--</option>
	...
	<option value="31" <?php if ($landlords_filter_lc_day==31) { echo "selected";}?>>31</option>
	     ...
	     <div class="col-xs-1">
<section class="cta" style="background-color:#ffffff;padding:0px 0px;padding-bottom:0px">
	<select name="landlords_filter_lc_year" class="form-control input-sm" id="inputsm">
<p class="small">
<option value="0">--</option>
	<?php 
	$start_year = date ("Y") - 4;
