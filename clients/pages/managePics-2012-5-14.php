...
<TD VALIGN="MIDDLE" ALIGN="CENTER">
&nbsp;&nbsp;&nbsp;<B><FONT SIZE="+1"><NOBR>
<?php if (!($rowGetAd->EXTERNALPIC OR $rowGetAd->CLI!=$grid)) { ?>
MANAGE <?php }?>PICTURES
...
$MLSPIC = "http://files-2.mlscdn.com/property_photos/cf740c3b1c01e4ec4d2058311e1583b8/".$rowGetAd->EXTERNALID."_".$k.".jpg";
