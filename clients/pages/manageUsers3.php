...
?>
	...
	<tr>
	<td colspan="12" valign="top"  height="1" bgcolor="#000000"><img border="0" hspace="0" vspace="0" width="100%" height="1" src="../assets/images/blk_spacer.gif"></td>
	<TD>
...
echo "<img border='0' vspace='2' hspace='0' width='10' height='10' src='../assets/images/act.gif'>: </FONT></TD><TD><FONT SIZE='-2'>". $num_agentactive_ads . "</FONT></TD><TD><FONT SIZE='-2'>";
...
echo "<img border='0' vspace='2' hspace='0' width='10' height='10' src='../assets/images/inact.gif'>: </FONT></TD><TD><FONT SIZE='-2'>". $num_agentinactive_ads . "</FONT></TD></TR></TABLE>";
?>
</TD>	
