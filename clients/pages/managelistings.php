...
<?php if (isset($showback)) if ($showback != "no") { ?>
...
<TD><NOBR>
<FONT SIZE=-1>
Total Maximum # of Activated <img border='0' vspace='2' hspace='0' width='10' height='10' src='../assets/images/act.gif'> Ads: </NOBR></TD><TD><FONT SIZE=-1><?php if (isset($maxAct)) echo $maxAct;?></FONT></NOBR>
</TD>
...
echo "Total # of Active <img border='0' vspace='2' hspace='0' width='10' height='10' src='../assets/images/act.gif'> Ads: </NOBR></TD><TD><NOBR><FONT SIZE=-1>".$num_active_ads."</FONT></NOBR></TD></TR><TR><TD><NOBR><FONT SIZE=-1>";
...
echo "Total # of Active <img border='0' vspace='2' hspace='0' width='10' height='10' src='../assets/images/act.gif'> Ads over 30 days old: </FONT></NOBR></TD><TD><NOBR><FONT SIZE=-1>". $num_agency30oldactive_ads . "</FONT></NOBR></TD></TR><TR><TD><NOBR><FONT SIZE=-1>";
...
echo "Total # of Active <img border='0' vspace='2' hspace='0' width='10' height='10' src='../assets/images/act.gif'> Ads over 60 days old: </NOBR></TD><TD><NOBR><FONT SIZE=-1>".$num_agency60oldactive_ads."</FONT></NOBR></TD></TR><TR><TD><NOBR><FONT SIZE=-1>";
...
echo "Total # of Active <img border='0' vspace='2' hspace='0' width='10' height='10' src='../assets/images/act.gif'> Ads over 90 days old: </NOBR></TD><TD><NOBR><FONT SIZE=-1>".$num_agency90oldactive_ads."</FONT></NOBR></TD></TR><TR><TD><NOBR><FONT SIZE=-1>";
...
echo "Total # of Inactive <img border='0' vspace='2' hspace='0' width='10' height='10' src='../assets/images/inact.gif'> Ads: </NOBR></TD><TD><NOBR><FONT SIZE=-1>".$num_inactive_ads."</FONT></NOBR></TD></TR><TR><TD><NOBR><FONT SIZE=-1>";
?>


Total Maximum # of Listings:</FONT></NOBR></TD><TD><FONT SIZE=-1><B>Unlimited</B></FONT></NOBR></TD></TR></TABLE>
...
<TABLE><TR><TD>
<SPAN style="font-size:12px;"><B>Last 250 Ads posted to Craigslist by <?php if (isset($group)) echo $group ;?>:</B></SPAN>
<BR>
<div class="toplist">
<?php
...
<?php 
	...
	$quStrGetListing = "select * from ((CLASS INNER JOIN LOC ON CLASS.LOC=LOC.LOCID) INNER JOIN TYPES ON CLASS.TYPE=TYPES.TYPE) where CLI='$grid' and STATUS_PENDING!='0' ORDER BY `MOD` DESC, `UID` DESC";
