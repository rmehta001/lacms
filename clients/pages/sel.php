...
?>
		...
		<table border="0" cellspacing="0" cellpadding="5" height="0" BGCOLOR="lightgrey" width = "100%">
		<tr>
		<td align="center">
    ...
    if (!$thisCalc) {
		...
		<div class="controltext">
		 <a href="<?php echo "$PHP_SELF?op=sel&start=z&limitN=$rowLimitCount->COUNTOF"; ?>">Show all ads</a> -
		    <?php
if ($userFilter) {?>
		    	<a href="<?php echo "$PHP_SELF?op=sel&start=z&userFilter=n"; ?>">Show all ads for <?php echo $_SESSION["group"]; ?></a>
		    <?php } else {?>
		    	<a href="<?php echo "$PHP_SELF?op=sel&start=z&userFilter=1"; ?>">Show only <?php echo $_SESSION["handle"]; ?>'s ads</a>
		    <?php }?>
		   -
		    <?php
if ($activeFilter) {?>
...
<CENTER class = "pl-3">
<?php if ($user_level > 0) {?>
			<h5 align="left"><b>Mass operations:</b></h5>

		      <form class= "" action="<?php echo "$PHP_SELF?op=select_and_do&return_page=sel"; ?>" method="POST" name="moveform">
		      ...
		      <div class="input-group mb-3">
		      	<select class="form-control" size="1" name="sop" style="background-color:white">
					...
					<option value="feeprint">Make FULL FEE (print)</option>
			  		<option value="fee2">Make FEE</option>
			  		<option value="fee2print">Make FEE (print)</option>
...
<!--				<option value="clpost">p2cl</option> -->
		  			<option value="print">.</option>

			    </select>
		        <div class="input-group-prepend">
		          <button type="submit" class="btn btn-outline-secondary" NAME = "SUBMIT" type="button">Execute</button>
		        <!-- <INPUT class="btn btn-outline-secondary" TYPE=IMAGE SRC="../images/dotochecked.gif" NAME="SUBMIT"><br> -->
		        </div>
		      </div>
		  		<div class="controltext mb-2" align = "left" style = "font-size: 18px;">Select All: <input type="checkbox" name="allbox" value="sel_all" onClick="CheckAll();" TITLE="Check to select ALL listings for a multi-listing action"></div>



		        <!-- <INPUT TYPE=IMAGE SRC="../images/dotochecked.gif" NAME="SUBMIT"><br> -->

		  	<!-- <div class="controltext" align = "left" style = "font-size: 18px;">Select All: <input type="checkbox" name="allbox" value="sel_all" onClick="CheckAll();" TITLE="Check to select ALL listings for a multi-listing action"></div> -->
			</CENTER>
				</td>
...
<CENTER>
<?php
function displaySortTag($headingName, $sort, $sortDirection)
{
    $sortDirection = strtolower($sortDirection);
    $element = '<i class="fa fa-fw fa-sort"></i>';

    if ($headingName == $sort) {
        if ($sortDirection == 'asc') {
            $element = '<i class="fa fa-sort-up" aria-hidden="true"></i>';
        } else {
            $element = '<i class="fa fa-sort-down"></i>';
        }
        // else {
        //     $element = '<i class="fa fa-fw fa-sort"></i>';
        // }
...
function getUrlForSortingAds($headingName, $sort, $sortDirection)
{
    $sortDirection = strtolower($sortDirection);

    if ($headingName == $sort) {
        // if ($sortDirection == 'asc') {
        //     $urlSortDirection = 'DESC';
        // } elseif ($sortDirection == 'desc') {
        //     $urlSortDirection = '';
        // } else {
        //     $urlSortDirection = 'ASC';
        // }
        $urlSortDirection = $sortDirection == 'asc' ? 'DESC' : 'ASC';
        $url = $PHP_SELF . "?op=sel&sort=" . $headingName . "&sortD=" . $urlSortDirection;

    } else {
        $url = $PHP_SELF . "?op=sel&sort=" . $headingName . "&sortD=ASC";
    }

    return $url;
}

function generateAdsSortingHeader($headingName, $sort, $sortDirection, $displayName)
{
    $headingName = $headingName == 'MOD' ? '`MOD`' : $headingName;

    $element = '<a style = "display: flex"  href=' . getUrlForSortingAds($headingName, $sort, $sortDirection) . ">
					" . $displayName . displaySortTag($headingName, $sort, $sortDirection) . "</a>";

    return $element;
}
?>
<table border="0" class = "normal-tbl-font tbl-td-hover" cellspacing="0" cellpadding="0" height="6">
			<tr>
...
<br></FONT>
			...
			<td
				class="controltext"
				bgcolor="<?php if ($sort == "STATUS") {echo "#FFFFFF";} else {echo "#FFFF99";}?>"
			>
				&nbsp;
				<!-- <a
					href="<?php echo getUrlForSortingAds('STATUS', $sort, $sortD); ?>"
				>
					Status
				</a> -->

				<?php echo generateAdsSortingHeader('STATUS', $sort, $sortD, 'Status'); ?>
			</td>

<TD BGCOLOR=#FFFF99><FONT COLOR=#808080>|</FONT></TD>
			<td
				class="controltext"
				bgcolor="<?php if ($sort == "CID") {echo "#FFFFFF";} else {echo "#FFFF99";}?>"
			>
				&nbsp;
				<!-- <a href="<?php echo "$PHP_SELF?op=sel&sort=CID&sortD=ASC"; ?>">ID#</a> -->
				<?php echo generateAdsSortingHeader('CID', $sort, $sortD, 'ID#'); ?>

			</td>
<TD BGCOLOR=#FFFF99><FONT COLOR=#808080>|</FONT></TD>
			<td
				class="controltext"
				bgcolor="<?php if ($sort == "DATEIN") {echo "#FFFFFF";} else {echo "#FFFF99";}?>"
			>
				&nbsp;
				 <!-- <a href="<?php echo "$PHP_SELF?op=sel&sort=DATEIN&sortD=ASC"; ?>">Created</a> -->
				<?php echo generateAdsSortingHeader('DATEIN', $sort, $sortD, 'Created'); ?>
			</td>
<TD BGCOLOR=#FFFF99><FONT COLOR=#808080>|</FONT></TD>
			<td
				class="controltext"
				bgcolor="<?php if ($sort == '`MOD`') {echo "#FFFFFF";} else {echo "#FFFF99";}?>"
			>
				&nbsp;
				<!-- <a href="<?php echo "$PHP_SELF?op=sel&sort=MOD&sortD=ASC"; ?>">Modified </a> -->
				<?php echo generateAdsSortingHeader('MOD', $sort, $sortD, 'Modified'); ?>

			</td>
<TD BGCOLOR=#FFFF99><FONT COLOR=#808080>|</FONT></TD>
			<td
				class="controltext"
				bgcolor="<?php if ($sort == "LOCNAME") {echo "#FFFFFF";} else {echo "#FFFF99";}?>"
			>
				&nbsp;
				<!-- <a href="<?php echo "$PHP_SELF?op=sel&sort=LOCNAME&sortD=ASC"; ?>">Location</a> -->
				<?php echo generateAdsSortingHeader('LOCNAME', $sort, $sortD, 'Location'); ?>
			</td>
<TD BGCOLOR=#FFFF99><FONT COLOR=#808080>|</FONT></TD>
			<td
				class="controltext"
				bgcolor="<?php if ($sort == "LANDLORD.SHORT_NAME") {echo "#FFFFFF";} else {echo "#FFFF99";}?>"
			>
				&nbsp;
				<!-- <a href="<?php echo "$PHP_SELF?op=sel&sort=LANDLORD.SHORT_NAME&sortD=ASC"; ?>">Landlord</a> -->
				<?php echo generateAdsSortingHeader('LANDLORD.SHORT_NAME', $sort, $sortD, 'Landlord'); ?>
...
<TD BGCOLOR=#FFFF99><FONT COLOR=#808080>|</FONT></TD>
			...
			<td
				class="controltext"
				bgcolor="<?php if ($sort == "PRICE") {echo "#FFFFFF";} else {echo "#FFFF99";}?>"
			>
				&nbsp;
				<!-- <a href="<?php echo "$PHP_SELF?op=sel&sort=PRICE&sortD=ASC"; ?>">Price</a> -->
				<?php echo generateAdsSortingHeader('PRICE', $sort, $sortD, 'Price'); ?>
...
<TD BGCOLOR=#FFFF99><FONT COLOR=#808080>|</FONT></TD>
			...
			>
				&nbsp;
				<!-- <a href="<?php echo "$PHP_SELF?op=sel&sort=ROOMS&sortD=ASC"; ?>">Size</a> -->
				<?php echo generateAdsSortingHeader('ROOMS', $sort, $sortD, 'Size'); ?>
...
<TD BGCOLOR=#FFFF99><FONT COLOR=#808080>|</FONT></TD>
			...
			<td
				class="controltext"
				bgcolor="<?php if ($sort == "AVAIL") {echo "#FFFFFF";} else {echo "#FFFF99";}?>"
			>
				&nbsp;
				<!-- <a href="<?php echo "$PHP_SELF?op=sel&sort=AVAIL&sortD=ASC"; ?>">Available</a> -->
				<?php echo generateAdsSortingHeader('AVAIL', $sort, $sortD, 'Available'); ?>
...
<TD BGCOLOR=#FFFF99><FONT COLOR=#808080>|</FONT></TD>
			...
			<td
				class="controltext"
				bgcolor="<?php if ($sort == "HANDLE") {echo "#FFFFFF";} else {echo "#FFFF99";}?>"
			>
				&nbsp;
				<!-- <a href="<?php echo "$PHP_SELF?op=sel&sort=HANDLE&sortD=ASC"; ?>">Agent</a> -->
				<?php echo generateAdsSortingHeader('HANDLE', $sort, $sortD, 'Agent'); ?>

			</td>
<TD BGCOLOR=#FFFF99><FONT COLOR=#808080>|</FONT></TD>
			<td
				class="controltext"
				bgcolor="<?php if ($sort == "PIC") {echo "#FFFFFF";} else {echo "#FFFF99";}?>"
			>
				&nbsp;
				<!-- <a href="<?php echo "$PHP_SELF?op=sel&sort=PIC&sortD=ASC"; ?>">Pictures</a> -->
				<?php echo generateAdsSortingHeader('PIC', $sort, $sortD, 'Pictures'); ?>

			</td>

<?php if (isset($rowGetGroup) and $rowGetGroup->AGENCIES > "0") {?>
<TD BGCOLOR=#FFFF99><FONT COLOR=#808080>| </FONT></TD>
			<td
				class="controltext"
				bgcolor="<?php if ($sort == "AGENCY_HEADERS") {echo "#FFFFFF";} else {echo "#FFFF99";}?>">
				&nbsp;
				<!-- <a href="<?php echo "$PHP_SELF?op=sel&sort=AGENCY_HEADERS&sortD=ASC"; ?>">Office</a> -->
							<?php echo generateAdsSortingHeader('AGENCY_HEADERS', $sort, $sortD, 'Office'); ?>
			</td>
<?php }?>
...
&nbsp;
    ...
    ?>
		    ...
		    <tr>
		      ...
		      <td width="8%" align="right" bgcolor="#FFFFFF" rowspan="2" VALIGN="TOP"><FONT SIZE="-4"><BR></FONT><NOBR><font color="#000000" face="Verdana" size="1"><?php echo $_SESSION["abv"] . "-" . $rowGetAds->CID; ?>&nbsp; <input tabindex="2" id="ad<?php echo $k++; ?>k" type="checkbox" name="sel_ids[]" value="<?php echo $rowGetAds->CID; ?>" TITLE="Check to select listing for a multi-listing action"></NOBR><BR><BR><CENTER>
...
<?php if ($rowGetAds->PIC != 0) {
    ...
    ?>
		      ...
		      <td width="400" height="26" bgcolor="#FFFFFF"><font color="#000000" face="Verdana" size="1"><NOBR>


<?php if ($user_level > 0) {
        ?>

		      <?php if ($rowGetAds->STATUS == "ACT") {echo "<a href='$PHP_SELF?op=deactivate&cid=$rowGetAds->CID&return_page_div=$k'><img border='0' vspace='0' hspace='0' width='16' height='16' src='../assets/images/act.gif' alt='Activated Ad - Click to shut off the Ad' title='Activated Ad - Click to shut off the Ad'></a>";} else {echo "<a href='$PHP_SELF?op=activate&cid=$rowGetAds->CID'><img border='0' vspace='0' hspace='0' width='16' height='16' src='../assets/images/inact.jpg' alt='Deactivated Ad -  - Click to Advertise This Listing' title='Deactivated Ad - Click to Advertise This Listing'></a>";}?>
...
<?php }?>
<img src="../assets/images/icons/a.jpg" border=0 height=16 width=16 alt="Available Unit - Click to Mark Unavailable" title="Available Unit - Click to Mark Unavailable">
<?php if ($user_level > 0) {?>
</a>
<?php }?>
...
<?php }?>
<img src="../assets/images/icons/u.jpg" border=0 height=16 width=16 alt="Unavailable Unit - Click to Mark Available" title="Unavailable - Click to Mark Available">
<?php if ($user_level > 0) {?>
</a>
<?php }?>
			<?php }?>
...
<!-- <a href="<?php echo "$PHP_SELF?op=cl_managePics&cid=$rowGetAds->CID"; ?>" target="new<?php echo $rowGetAds->CID; ?>"><img width="16" height="16" border="0" vspace="0" hspace="0" src="../images/icons/cl.gif" alt="Post to Craigslist" title="Post to Craigslist"></a> -->

<a href="<?php echo "https://www.BostonApartments.com/plugin/?ad=$rowGetAds->CID&cli=$rowGetAds->CLI&uid=$uid\" target=\"_CL$rowGetAds->CID\""; ?>"><img width="16" height="16" border="0" vspace="0" hspace="0" src="../images/icons/cl.gif" alt="Post to Craigslist" title="Post to Craigslist"></A>


<a href="<?php echo "http://www.facebook.com/sharer.php?u=http%3A%2F%2Fbostonapartments.com%2Fhomepage-fb.php%3Fcli%3D$rowGetAds->CLI%26ad%3D$rowGetAds->CID"; ?>" target="_FB<?php echo $rowGetAds->CID; ?>"><img width="16" height="16" border="0" vspace="0" hspace="0" src="../images/icons/facebook.gif" alt="Post to Facebook" title="Post to Facebook"></A>
