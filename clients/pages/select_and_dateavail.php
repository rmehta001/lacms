...
<BR>
	...
	This form will change Availability Date in <?php echo $numIDs ;?> Selected Listings<BR><BR>
<P>

	<form action="<?php echo "$PHP_SELF?op=select_and_availdate";?>" method="POST">
...
<input type="submit" value="Change the Availability Date in ALL the listings at this building" STYLE="Background-Color : #A9F5A9"></form>
<br>
<P>
<P>&nbsp;<BR>
