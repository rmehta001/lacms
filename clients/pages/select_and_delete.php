...
<?php if ($numIDs >0) { ;?>
	...
	Are you sure you want to delete these <?php echo $numIDs;?> ad(s)?<BR>
<P>

	<form action="<?php echo "$PHP_SELF?op=select_and_delete";?>" method="POST">
<input TYPE="HIDDEN" NAME="return_page" value="<?php echo "$return_page";?>">
	...
	<?php } ?>
		...
		<input type="submit" value="Delete Ads" STYLE="Background-Color : #A9F5A9"></form>
		<br>
...
<?php } else { ;?>
	<font color="#000000" face="Verdana">
	You can't delete <?php echo $numIDs;?> these ads. You need to select at least one.<BR>
<P>
