...
<center>
		...
		$street_num = $HTTP_GET_VARS['street_num'];		
		$street = $HTTP_GET_VARS['street'];
		
				
	$qustrGetaCID = "select * from CLASS where  CLI='$grid' AND STREET='$street' AND STREET_NUM='$street_num' AND LANDLORD='$lid' LIMIT 1";
	$quGetaCID = mysqli_query($dbh, $qustrGetaCID) or die (mysqli_error($dbh));
	$GetaCID = mysqli_fetch_object($quGetaCID) ;
...
?>
		...
		<td align="center" bgcolor="<?php echo $pagebgcolor; ?>" width="50%">
				...
				<td align="center" height="30" bgcolor="<?php echo $pagebgcolor; ?>"><div class="controltext">Upload Picture for the WHOLE building at<BR><?php echo "$street_num $street";?><BR> For landlord # <?php echo "$lid";?></div><div class="ad"><?php echo $abv;?>-<?php echo $cid;?></div></td>
				</tr>
				</table>
		</td>
		<td valign="top" height="30" width="1" bgcolor="#000000"><img border="0" hspace="0" vspace="0" width="1" height="100%" src="../assets/images/blk_spacer.gif"></td>
		...
		<form enctype="multipart/form-data" action="<?php echo "$PHP_SELF?op=uploadPreview1tomany-b";?>" method="POST">
