...
<center>
		...
		<td align="center" bgcolor="<?php echo $pagebgcolor;?>" width="50%">
				...
				<td align="center" height="30" bgcolor="<?php echo $pagebgcolor;?>"><div class="controltext">Choose the size for picture to be added to listing <?php echo $abv;?>-<?php echo $cid;?></div></td>
				</tr>
				</table>
		</td>
		<td valign="top" height="30" width="1" bgcolor="#000000"><img border="0" hspace="0" vspace="0" width="1" height="100%" src="../assets/images/blk_spacer.gif"></td>
		...
		<form action="<?php echo "$PHP_SELF?op=uploadDo"; ?>" method="POST">
