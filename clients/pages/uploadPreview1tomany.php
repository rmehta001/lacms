...
<center>
		...
		$Lookup = mysqli_fetch_object($quLookup)
				...
				<?php echo "$Lookup->STREET_NUM $Lookup->STREET"; ?>
				<BR>For Landlord # <?php echo "$Lookup->LANDLORD";?> / <?php echo $abv;?>-<?php echo $cid;?></div></td>
				</tr>
				</table>
		</td>
		<td valign="top" height="30" width="1" bgcolor="#000000"><img border="0" hspace="0" vspace="0" width="1" height="100%" src="../assets/images/blk_spacer.gif"></td>
		...
		<input type="hidden" name="landlord" value="<?php echo $Lookup->LANDLORD;?>">
		<input type="hidden" name="street" value="<?php echo $Lookup->STREET;?>">
		<input type="hidden" name="street_num" value="<?php echo $Lookup->STREET_NUM;?>">
