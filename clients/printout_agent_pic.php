...
<td height="500" bgcolor="#FFFFFF" valign="top">
	<table width="100%" align="center"  border="0">
	<tr>
	<td colspan="3" align="left" height="30" width="100%" bgcolor="#FFFFFF"><NOBR><DIV class="ad"><B><a href="/lacms/clients/AgencyArea2.php?op=adlEdit&cid=<?php echo $rowGetAd->CID;?>&return_page=listings" target="_new<?php echo $k;?>">Listing #<?php echo "$abv-$cid";?></A></B> - Created:  <?php echo $rowGetAd->DATEIN ;?> Last Modified: <?php echo $rowGetAd->MOD ; ?> 
...
<?php if ($user_level>0) {?>
		<a href="<?php echo "$PHP_SELF?op=activate_a&cid=". $rowGetAd->CID . "&return_page=listings&return_page_div=" . $k; ?>">
<?php } ?>
...
<?php if ($user_level>0) {?>
                              ...
                              <a href="<?php echo "$PHP_SELF?op=mark_status_active&cid=".$rowGetAd->CID . "&turn=unavailable&return_page=listings&return_page_div=" . $k;?>">
<?php }?>
...
<B>Alarm Code:</B><BR><?php echo $rowGetAd->ALARM;?><BR>
	...
	<tr>
	<td colspan="3" align="left" height="30" width="100%" bgcolor="#FFFFFF">
...
while ($rowGetPics = mysqli_fetch_object($quGetPics)) { 
	...
	?><img src="<?php echo $pic;?>"><br><div class="ad"><?php echo $rowGetPics->DESCIPT;?></div><br>
<?php }?>
<?php echo $rowGetAd->YOUTUBE ;?>
