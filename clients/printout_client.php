...
// USER INFORMATION //
$qustrgetuser = "SELECT * FROM USERS WHERE UID='$rowGetAd->UID'";
...
?>
		...
		<tr>
		<td  width="50%" bgcolor="#FFFF99" valign="bottom" align="left"><div class="ad">Printed by <?php echo $_SESSION["handle"];?> on the BostonApartments.com System<BR>
</div></td>
...
<td height="500" bgcolor="#FFFFFF" valign="top">
	...
	<tr>
	<td colspan="3" align="left" height="30" width="100%" bgcolor="#FFFFFF"><div class="controltextimp"><B><a href="/lacms/clients/AgencyArea2.php?op=adlEdit&cid=<?php echo $rowGetAd->CID;?>&return_page=listings" target="_new<?php echo $k;?>">Listing #<?php echo $_SESSION["abv"]."-$cid";?>
