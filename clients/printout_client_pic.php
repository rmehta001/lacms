...
$qugetuser = mysqli_query($GLOBALS['dbh'], $qustrgetuser) or die (dieNice("Sorry, couldn't lookup that ad.", "E-117"));
...
<tr>
<td valign="top" width="1"><img border="0" hspace="0" vspace="0" width="1" height="100%" src="../assets/images/blk_spacer.gif"></td>
...
<td bgcolor="#FFFF99" valign="top">
		...
		<tr>
		<td align="left" width="50%" bgcolor="#FFFF99" VALIGN="TOP"><div class="menu"><?php echo $rowGetAd->NAME;?><br><?php echo $rowGetAd->SIG;?><BR>

</div></td>		
		<td align="left" width="50%" bgcolor="#FFFF99" VALIGN="TOP"><div class="menu">

<?php 

if ($rowGetAd->FNAME !== "") {
echo "<B>Agent:</B> &nbsp;" . $rowgetuser->FNAME . " " . $rowgetuser->LNAME;
}

if ($rowGetAd->DIRECTLINE != "") {
echo "<BR><B>Direct:</B> &nbsp;" . $rowgetuser->DIRECTLINE;
}

if ($rowGetAd->CELLPHONE != "") {
echo "<BR><B>Cellular:</B> &nbsp;" . $rowgetuser->CELLPHONE;
}
if ($rowGetAd->EMAIL != "") {
echo "<BR><B>Email:</B> &nbsp;" . $rowgetuser->EMAIL;
}
?>
</DIV>
</td>
		...
		<tr>
		<td  width="50%" bgcolor="#FFFF99" valign="bottom" align="left"><div class="ad">Printed by <?php echo $handle;?> on the BostonApartments.com System<BR>
</div></td>
		<td width="50%" bgcolor="#FFFF99" valign="bottom" align="right"><div class="controltext"><a href="javascript:close_window();">Close Window</a> || <a href="javascript:print_screen();">Send to Printer</a></div></td>
		</tr></table>
...
<td height="500" bgcolor="#FFFFFF" valign="top">
	...
	<tr>
	<td colspan="3" align="left" height="30" width="100%" bgcolor="#FFFFFF"><div class="controltextimp"><B><a href="/lacms/clients/AgencyArea2.php?op=adlEdit&cid=<?php echo $rowGetAd->CID;?>&return_page=listings" target="_new<?php echo $k;?>">Listing #<?php echo "$abv-$cid";?></td>
	</tr>
	<tr>
...
if (($rowGetAd->CONDO_FEES!="0") OR ($rowGetAd->CONDO_FEES_INCLUDE)) { echo "<BR>"; }
...
if ($rowGetAd->FEATURES_DELEADED =="1") { echo " | Deleaded / Lead Safe"; }
...
?>
	...
	<tr> 
	<td colspan="3" align="left" height="30" width="100%" bgcolor="#FFFFFF"><div class="menu"><B>Address:</B> <?php echo $rowGetAd->STREET;?> <?php if ($rowGetAd->APT) { echo  "Apt $rowGetAd->APT"; }?>, <?php echo $rowGetAd->LOCNAME;?> <?php echo $rowGetAd->ZIP;?></div></td>
	</tr>

	<tr> 
	<td colspan="3" align="left" height="30" width="100%" bgcolor="#FFFFFF"><div class="menu">

	<?php 
$quStrGetPics = "SELECT * FROM PICTURE WHERE CID='$cid'";
$quGetPics = mysqli_query($GLOBALS['dbh'], $quStrGetPics);

while ($rowGetPics = mysqli_fetch_object($quGetPics)) { 
	$pic = "../../pics/$rowGetPics->PID.$rowGetPics->EXT";
	?><CENTER><BR><img src="<?php echo $pic;?>"></CENTER><br>
