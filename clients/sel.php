...
<?php if ($user_level>0) {?>
		      ...
		      <select size="1" name="sop" style="background-color:white">
				...
				<option value="pendingno">Mark Not Pending</option>
		  		...
		  		<option value="fee">Make FULL FEE</option>			  		<option value="feeprint">Make FULL FEE (print)</option>
...
<?php if ($rowGetGroup->AGENCIES > "0") { ?>
<TD BGCOLOR=#FFFF99><FONT COLOR=#808080>| </FONT></TD>
<td class="controltext" bgcolor="<?php if ($sort=="AGENCY_HEADERS") {echo "#FFFFFF"; } else { echo "#FFFF99";} ?>">&nbsp;<a href="<?php echo "$PHP_SELF?op=sel&sort=AGENCY_HEADERS&sortD=ASC";?>">Office</a> &nbsp;</td>
<?php } ?>
