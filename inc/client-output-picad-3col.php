...
//	$rooms_formated=preg_replace('/-/',' ',$rooms_formated);
	...
	$adString="<tr valign=top><td valign=middle align=center>$thumb&nbsp;<font size=1>$morePics</td><td><font size=2>$thisRowGetAds->LOCNAME - $noFee $rooms $baths $thisRowGetAds->BODY $amenity_string $feature_string $hasExternalPics $hasVirtualTour $hasYouTubeURL $isNew #$thisRowGetAds->CID&nbsp;&nbsp;$signature $fdate </TD><TD><CENTER>&nbsp; $price &nbsp;<CENTER></td></tr>";
	return $adString;
}
?>
