...
if ($recordset->LAST_CONTACT_ACTION == "8") { $LCA="- Other" ;}
		...
		$string .= "<a href=$PHP_SELF?op=editLandlord&lid=$recordset->LID>$recordset->HOME_NAME_FIRST $recordset->HOME_NAME_LAST, $recordset->OFF_NAME</A><br>";
		$string .= $emailString;
...
function format_ad ($thisRowGetAds, $thisDEFINED_VALUE_SETS) {
	...
	$hasPics = ($thisRowGetAds->PIC) ? "<a href=\"http://www.bostonapartments.com/homepage.php?cli=$thisRowGetAds->CLI&ad=$thisRowGetAds->CID\" target=\"blank\"><img border='0' width='22' height='12' src='http://www.bostonapartments.com/images/pic.gif'></a>" : "";

	$hasExternalPics = ($thisRowGetAds->EXTERNALPIC) ? "<A HREF=\"http://www.bostonapartments.com/homepage-MLS.php?cli=1075&ad=$thisRowGetAds->CID\"><img border='0' width='22' height='12' src='http://www.bostonapartments.com/images/pic.gif'></a>" : "";


	$hasVirtualTour = ($thisRowGetAds->VIRT_TOUR) ? "<a href=\"$thisRowGetAds->VIRT_TOUR\" target=\"blank\"><img border='0' width='59' height='11' src='http://www.bostonapartments.com/images/virtualtour.gif'></a>" : "";
...
$condofee =  ($thisRowGetAds->CONDO_FEES) ? "<B>Condo Fee:</B> \$".$thisRowGetAds->CONDO_FEES : "";} else {$condofee = "";}
	...
	$signature = ($thisRowGetAds->ALTSIG) ? "$thisRowGetAds->ALTSIG" : "$thisRowGetAds->SIG";
	$signature = eregi_replace ("<A HREF=\"", "<A HREF=\"http://www.BostonApartments.com/", $signature);
	$signature = eregi_replace ("<A HREF=\"http://www.BostonApartments.com/http://www.BostonApartments.com/", "<A HREF=\"http://www.BostonApartments.com/", $signature);
	$signature = eregi_replace ("<A HREF=\"http://www.BostonApartments.com/mailto:", "<A HREF=\"mailto:", $signature);
	$signature = eregi_replace ("http://www.BostonApartments.com/http:", "http:", $signature);
...
function format_ad_email ($thisRowGetAds, $thisDEFINED_VALUE_SETS) {
	...
	$hasPics = ($thisRowGetAds->PIC) ? "<BR>Picture Link: <A HREF='http://www.bostonapartments.com/homepage.php?cli=$thisRowGetAds->CLI&ad=$thisRowGetAds->CID'>http://www.bostonapartments.com/homepage.php?cli=$thisRowGetAds->CLI&ad=$thisRowGetAds->CID</A><BR>" : "";
...
function make_map ($rowGetAd) {
	...
	$url .= "?$arg_str";
	$link = "<a href=\"$url\" target=\"new\"><IMG SRC='http://www.bostonapartments.com/images/map.gif' BORDER='0' height='12' width='48'></a>";
	return $link;
}
...
function get_thumb ($thisRowGetAds)
{
   ...
   {
      $rowGetPics="<a href=\"http://www.bostonapartments.com/homepage.php?cli=$thisRowGetAds->CLI&ad=$thisRowGetAds->CID$agenteml\"><img border=0 src='http://www.bostonapartments.com/pics/$thisRowGetAds->THUMBNAIL' width='125' alt='$rowGetPics->DESCRIPT'></a><br>";
   } else {
      ...
      {
         $rowGetPics="<a href=\"http://www.bostonapartments.com/homepage.php?cli=$thisRowGetAds->CLI&ad=$thisRowGetAds->CID$agenteml\"><img border=0 src='http://www.bostonapartments.com/pics/$rowGetPics->PID.$rowGetPics->EXT' width='125' alt='$rowGetPics->DESCRIPT'></a><br>"; 
      }
   }
   
   if ($thisRowGetAds->EXTERNALPIC) {
            $rowGetPics="<a href=\"http://www.bostonapartments.com/homepage.php?cli=$thisRowGetAds->CLI&ad=$thisRowGetAds->CID$agenteml\"><img border=0 src='$thisRowGetAds->EXTERNALPIC' width='125' height='125' alt='$rowGetPics->DESCRIPT'></a><br>"; 
   }
   ...
   //if($thisRowGetAds->THUMBNAIL)
{
      ...
      if($rowGetPics = mysqli_fetch_object($quGetPics))
      {
         $rowGetPics="http://www.bostonapartments.com/pics/$rowGetPics->PID.$rowGetPics->EXT"; 
      }
   }
 else {
      ...
      if ($thisRowGetAds->EXTERNALPIC) {
            $rowGetPics="<a href=\"http://www.bostonapartments.com/homepage.php?cli=$thisRowGetAds->CLI&ad=$thisRowGetAds->CID\" rel=\"gb_page_fs[]\"><img border=0 src='$thisRowGetAds->EXTERNALPIC' width='125' height='125' alt='$rowGetPics->DESCRIPT'></a><br>"; 
   }
