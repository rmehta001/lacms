...
/*///////////////////////////////////////////////////////////////////////////
//bstapts login routine 2.5.   Copyright 2017 BostonApartments.com //
//////////////////////////////////////////////////////////////////////////*/
...
if (isset($_POST['username']) && isset($_POST['password'])) {
    //    if (mysqli_num_rows(mysqli_query($dbh, "SELECT * FROM USERS WHERE HANDLE = //'{$username}' AND PASS = '{$password}'")) == 0)
    $sql = "SELECT * FROM USERS WHERE HANDLE = '{$user}'
		AND PASS = '{$pass}'";
    //    error_log($dbh, 0);
    if (mysqli_num_rows(mysqli_query($dbh, $sql)) == 0) {
        // User wrongly logged in - incorrect user/pass - send back
...
$_SESSION["intellirent"] = $rowUsr["INTELLIRENT"];
...
$_SESSION['show_hot_list'] = true;
$_SESSION['type'] = $rowUsr["AGENT_TYPE"];
$sid = session_id();
$now = date("YmdHis");
$uid = $_SESSION['uid'];
$grid = $_SESSION['grid'];
